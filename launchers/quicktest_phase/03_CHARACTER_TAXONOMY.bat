...
echo Phase:    03 Character taxonomy
...
echo.
echo COMMAND: python -m orchestrator synthesize-character-taxonomy "%PROJECT_SLUG%" --force
echo.

python -m orchestrator synthesize-character-taxonomy "%PROJECT_SLUG%" --force
