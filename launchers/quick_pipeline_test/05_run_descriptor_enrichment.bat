...
echo.
echo ========================================
echo Quick Pipeline Test: Descriptor Enrichment
echo ========================================
echo.
set "PROJECT_SLUG=%~1"
...
echo.
echo Running descriptor enrichment synthesis...
python -m orchestrator synthesize-descriptor-enrichment %PROJECT_SLUG% --force --chapters %CHAPTERS%
if errorlevel 1 goto :fail

echo.
echo Descriptor enrichment synthesis complete.
goto :done

:fail
echo.
echo Descriptor enrichment synthesis failed.
popd >nul
exit /b 1
