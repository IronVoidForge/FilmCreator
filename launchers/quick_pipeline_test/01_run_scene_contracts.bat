...
echo.
echo ========================================
echo Quick Pipeline Test: Scene Contracts
echo ========================================
echo.
set "PROJECT_SLUG=%~1"
...
echo.
echo Running scene contract synthesis...
python -m orchestrator synthesize-scene-contracts %PROJECT_SLUG% --chapters %CHAPTERS%
if errorlevel 1 goto :fail

echo.
echo Scene contract synthesis complete.
goto :done

:fail
echo.
echo Scene contract synthesis failed.
popd >nul
exit /b 1
