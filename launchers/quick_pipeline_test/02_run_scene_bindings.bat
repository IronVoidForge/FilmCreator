...
echo.
echo ========================================
echo Quick Pipeline Test: Scene Bindings
echo ========================================
echo.
set "PROJECT_SLUG=%~1"
...
echo.
echo Running scene binding synthesis...
python -m orchestrator synthesize-scene-bindings %PROJECT_SLUG% --chapters %CHAPTERS%
if errorlevel 1 goto :fail
