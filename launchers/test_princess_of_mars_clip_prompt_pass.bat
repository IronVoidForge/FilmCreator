...
python -m orchestrator write-prompts princess_of_mars_test --scene SC001
if errorlevel 1 goto :fail

echo.
echo If this worked, inspect:
echo   C:\FilmCreator\projects\princess_of_mars_test\03_prompt_packages\scenes\SC001\
echo   C:\FilmCreator\projects\princess_of_mars_test\03_prompt_packages\keyframes\SC001\
echo   C:\FilmCreator\projects\princess_of_mars_test\03_prompt_packages\fixes\SC001\
echo   C:\FilmCreator\projects\princess_of_mars_test\03_prompt_packages\cut_motion\SC001\
pause
exit /b 0
