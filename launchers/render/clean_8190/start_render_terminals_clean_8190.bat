...
echo Waiting briefly for clean ComfyUI to answer on 8190...
...
start "FilmCreator Clean Render Shell" cmd /k "cd /d %FILMCREATOR_ROOT% && set FILMCREATOR_COMFY_BASE_URL=http://127.0.0.1:8190 && set FILMCREATOR_COMFY_INPUT_DIR=%CLEAN_INPUT% && set FILMCREATOR_COMFY_OUTPUT_DIR=%CLEAN_OUTPUT% && echo Clean render shell ready. && echo FILMCREATOR_COMFY_BASE_URL=%FILMCREATOR_COMFY_BASE_URL% && echo FILMCREATOR_COMFY_INPUT_DIR=%FILMCREATOR_COMFY_INPUT_DIR% && echo FILMCREATOR_COMFY_OUTPUT_DIR=%FILMCREATOR_COMFY_OUTPUT_DIR% && echo. && echo Current pilot batch command: && echo python -m orchestrator run-batch projects/pilot_scene/05_scenes/SC001/clips/CL001/logs/RUN_0001.json --ref image_1=projects/pilot_scene/05_scenes/SC001/clips/CL001/inputs/smoke_env.png --ref image_2=projects/pilot_scene/05_scenes/SC001/clips/CL001/inputs/smoke_char.png --seed-base 3000 --execute"
