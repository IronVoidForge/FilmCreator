...
- timestamp_utc: 2026-04-28T04:17:18.488076+00:00
...
likely visual coverage families: Wide establishing shots of the court; medium shots of the jury's slates; close-ups of Alice's face and the stolen pencil.
likely continuity sensitivities: Size of Alice relative to the jurors; the presence of the dish of tarts on the central table.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
scene_id: SC002
[[SECTION markdown]]
scene purpose: Formal commencement of the trial and introduction of the first witness.
scene summary: The White Rabbit blows his trumpet and reads the formal charge against the Knave: stealing the Queen's tarts. The Hatter enters as the first witness, accompanied by the March Hare and a sleepy Dormouse, carrying tea and bread-and-butter.
...
participating environments: The Court of Justice.
dominant emotional shift: Formal tension to nonsensical confusion.
likely visual coverage families: Low angle on the White Rabbit with trumpet; tracking shot following the Hatter's entrance; medium shots of the King questioning the Hatter.
likely continuity sensitivities: The tea set and bread-and-butter carried by the Hatter; the Dormouse's level of sleepiness.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
scene_id: SC003
[[SECTION markdown]]
scene purpose: Escalation of the trial's absurdity and Alice's physical transformation.
scene summary: The King conducts a nonsensical cross-examination of the Hatter regarding dates and his hat. As the Hatter becomes increasingly nervous under the Queen's gaze, Alice begins to grow in size. This growth causes the Dormouse to move away in discomfort. The trial descends into further nonsense with "the twinkling of the tea."
...
likely visual coverage families: Close-ups of the Hatter biting his teacup; scale shots showing Alice growing larger than the surrounding characters/furniture.
likely continuity sensitivities: Alice's height increasing incrementally; the position of the Dormouse relative to Alice.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
scene_id: SC004
[[SECTION markdown]]
scene purpose: Climax of the first witness segment and the transition to the second witness.
scene summary: Chaos erupts as guinea-pigs are suppressed in a bag. The Hatter, overwhelmed, flees the court without his shoes. The Queen orders his execution, but he is already gone. The Cook enters with her pepper-box, causing sneezing fits. A brief exchange about tart ingredients leads to a screaming outburst from the Queen regarding the Dormouse, and the Cook disappears in the confusion.
...
participating environments: The Court of Justice.
dominant emotional shift: High chaos/aggression.
likely visual coverage families: Fast-paced cutting during the Queen's outburst; reaction shots of characters sneezing; wide shot of the court in disarray.
likely continuity sensitivities: The presence of the pepper-box; the sudden disappearance of the Cook.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
scene_id: SC005
[[SECTION markdown]]
scene purpose: Cliffhanger/Transition to Alice's testimony.
scene summary: After the chaos of the Cook's exit, the White Rabbit consults his parchment and announces that the next witness is Alice.
...
likely visual coverage families: Close-up on the White Rabbit's list; close-up on Alice's reaction to being called.
likely continuity sensitivities: Alice's current large size.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
[[/FILMCREATOR_RECORD]]
[[/FILMCREATOR_PACKET]]
