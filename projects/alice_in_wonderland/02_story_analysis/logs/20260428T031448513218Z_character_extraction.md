...
- timestamp_utc: 2026-04-28T03:14:48.513218+00:00
...
direct_visual_evidence: Described as growing to nine feet tall, then shrinking to two feet tall; head strikes ceiling; swimming in a pool of tears.
...
A young girl whose scale fluctuates wildly throughout the chapter. She grows to over nine feet tall (head striking the ceiling) and later shrinks to approximately two feet tall. 

**Costume & Silhouette:**
- Variable scale silhouette.
- Noted wearing a white kid glove (belonging to the White Rabbit) during her shrinking phase.
...
**Uncertainty Notes:**
Specific facial features, hair color, and eye color are not explicitly detailed in this chapter text.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
direct_visual_evidence: Trotting hurriedly, dressed splendidly, carrying white kid gloves and a large fan.
costume_or_covering_evidence: Dressed "splendidly"; carries white kid gloves and a large fan.
movement_evidence: Trotting, dropping items, scurrying into darkness.
associated_entities: Alice, The Duchess (referenced)
alias_or_role_evidence: 
unknowns: Specific colors of clothing or rabbit fur.
source_refs: 
[[SECTION character_index_markdown]]
[[SECTION markdown]]
# White Rabbit
...
**Physical Description:**
A small animal (rabbit) that moves with human-like urgency and purpose.

**Costume & Silhouette:**
- Splendidly dressed (specific attire details unknown).
- Carries white kid gloves in one hand.
- Carries a large fan in the other hand.
...
**Uncertainty Notes:**
The exact style of "splendid" clothing is not defined.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
**Physical Description:**
A small aquatic animal found swimming in a pool of salt water.
...
**Uncertainty Notes:**
No visual details regarding fur color or size relative to Alice (other than being in the same pool) are provided.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
manual_description_reason: Character is only mentioned/referenced; no visual description provided in text.
clarification_required: false
clarification_reason: 
clarification_question: 
character_type_hint: animal
...
alias_or_role_evidence: 
unknowns: Appearance, color, breed.
source_refs: 
[[SECTION character_index_markdown]]
[[SECTION markdown]]
# Dinah
**Role:** Referenced Character (Alice's Cat)
...
**Uncertainty Notes:**
Character is not physically present; visual identity is entirely unknown based on this chapter.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
...
renderability_hint: renderable
confidence: 0.6
direct_identity_evidence: Identified as Duck, Dodo, Lory, and Eaglet.
...
[[SECTION character_index_markdown]]
[[SECTION markdown]]
# Pool Animals (Duck, Dodo, Lory, Eaglet)
**Role:** Supporting Characters

**Status:** Physically Present

**Physical Description:**
A collection of various birds and animals swimming in the pool.

**Costume & Silhouette:**
N/A

**Descriptive Noun Phrases:**
- Group of swimming animals
- A duck, a dodo, a lory, and an eaglet

**Uncertainty Notes:**
While their species are named, no specific visual details (color, size, texture) are provided for any individual member of this group.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
[[/FILMCREATOR_PACKET]]
````
