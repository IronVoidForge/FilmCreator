# Character Bible: march_hare

- character_id: `march_hare`
- status: `canonical`
- entity_kind: `group`
...
- display_name: march_hare
- aliases: (none)
- chapter_mentions: CH007

## Visual Bible

- identity_baseline: A human-scale quadruped entity.
...
- role: unknown
- voice_notes: unknown
- relationship_notes: Associated with Alice, Associated with The Hatter, Associated with The Dormouse
