# Environment Bible: swift_riverbank_and_meadow_view

- environment_id: `swift_riverbank_and_meadow_view`
- status: `canonical`
...
- display_name: swift_riverbank_and_meadow_view
- environment_type: Secondary / Transit Setting
- chapter_mentions: CH007

## Visual Bible

Insufficient descriptive data available to establish a visual profile. The environment is identified as a riverbank and meadow view.
...
- artifact_id: `ENV_swift_riverbank_and_meadow_view`
- status: `generated`
