# Environment Bible: poppy_field_bed

- environment_id: `poppy_field_bed`
- status: `canonical`
...
- display_name: poppy_field_bed
- environment_type: Secondary / Hazard Setting
...
- lighting: Unknown.
- mood: Unknown.
- recurring_elements: poppies (implied by ID)
...
- artifact_id: `ENV_poppy_field_bed`
- status: `generated`
