...
- timestamp_utc: 2026-04-20T16:56:19.373516+00:00
...
* [The Ape-like Creature](ape_like_creature)
...
manual_description_reason: No physical appearance, facial features, or clothing details are provided.
...
**Role:** Human captive and adventurer.
**Presence:** Physically present throughout the chapter.
**Physical Description:** A human with exceptional jumping abilities and an adventurous spirit.
**Uncertainty Notes:** Physical appearance, clothing, and specific facial features are entirely unstated.
...
aliases: Martian female

is_fully_identified: false

manual_description_required: true

manual_description_reason: No physical description or attire provided.
...
**Role:** A Martian female who interacts with the protagonist.
**Presence:** Referenced (leaves the protagonist at the start of the chapter).
**Physical Description:** Characterized by her kindness, sympathy, and care toward the protagonist.
**Uncertainty Notes:** No visual details regarding her species' appearance or clothing are available.
...
**Physical Description:** A ferocious, incredibly fast Martian beast used for hunting and protection.
**Traits:** High-speed movement, intimidating presence.
...
**Role:** Ambushing predator.
**Presence:** Physically present (appears at the end of the chapter).
**Physical Description:** A massive, white, hairless, and intimidating creature.
**Traits:** Colossal scale, pale/white skin, aggressive behavior.
