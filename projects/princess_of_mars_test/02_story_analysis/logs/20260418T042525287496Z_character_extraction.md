...
- timestamp_utc: 2026-04-18T04:25:25.287496+00:00
...
manual_description_reason: First-person narrator; no physical description provided in source text.
...
asset_id: sola
manual_description_required: true
manual_description_reason: Companion character; no physical description provided in source text.

[[SECTION markdown]]
# Sola

**Display Name:** Sola  
**Chapter Role:** Companion  
**Presence Status:** Physically Present  

**Physical Description:** None supported by source text. Character is identified only by name. No height, build, hair color, or skin tone details are provided in this chapter.  

**Costume & Silhouette:** None described. Attire is not mentioned in the source material for this specific scene.  

**Continuity-Critical Traits:**  
- Companion to John Carter.  
- Present during the fleet engagement and capture.  
- Rushes to Carter upon his return to the street.  

**Descriptive Noun Phrases:**  
- Female companion (implied by name context)  
- Warrior associate  
- Observer of the plaza scene  
...
asset_id: woola
manual_description_required: true
manual_description_reason: Generic hound designation; specific breed or markings not described in source text.
...
manual_description_required: true
manual_description_reason: Referenced warrior; no physical description provided in source text.
...
[[FILMCREATOR_RECORD]]
type: character
asset_id: the_captive
manual_description_required: false
manual_description_reason: Detailed physical description provided in source text (skin, hair, eyes, ornaments).

[[SECTION markdown]]
# The Captive

**Display Name:** The Captive  
**Chapter Role:** Prisoner / Subject  
**Presence Status:** Physically Present  

**Physical Description:** Slender, girlish figure. Oval face with finely chiseled features. Large lustrous eyes. Coal black waving hair caught loosely. Light reddish copper skin. Crimson cheeks and ruby lips. Destitute of clothes except for highly wrought ornaments.  

**Costume & Silhouette:** Naked except for highly wrought ornaments. Slender, girlish silhouette similar to earthly women.  

**Continuity-Critical Traits:**  
- Sole survivor of the airship crew (implied).  
- Captured by green Martian females.  
- Witnessed by John Carter in the plaza.  
- Subject of emotional reaction from Carter (hope, dejection).  

**Descriptive Noun Phrases:**  
- Slender girlish figure  
- Light reddish copper skin  
- Coal black waving hair  
- Ruby lips and crimson cheeks  
- Highly wrought ornaments  
- Oval face with finely chiseled features  

**Uncertainty Notes:**  
- Specific ornament designs are not detailed beyond "highly wrought".  
- Exact age is implied as young/girlish but not specified numerically.
[[/SECTION]]
[[/FILMCREATOR_RECORD]]
[[FILMCREATOR_RECORD]]
type: character
...
manual_description_required: true
manual_description_reason: Collective group description; individual build and variation not described beyond skin tone in source text.
