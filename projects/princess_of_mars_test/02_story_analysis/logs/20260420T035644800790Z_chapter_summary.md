...
- timestamp_utc: 2026-04-20T03:56:44.800790+00:00
...
[[SECTION project_summary_markdown]]
# Project Summary: Barsoom Rescue Arc

## Story Context
The narrative follows John Carter (the narrator) as he attempts to rescue Dejah Thoris from the captivity of Thark. The conflict centers on the rivalry between Helium and Thark, involving key figures such as Tal Hajus (Jeddak of Tharks), Tars Tarkas (Thark warrior), and Sola (Dejah Thoris' companion). Carter is aided by Woola (his Martian dog) and relies on his Martian technology (rifles, revolvers) to navigate the dangers. The overarching goal is to return Dejah Thoris safely to Helium, despite the constant threat of recapture by Thark warriors.

## Visual Continuity
The setting alternates between the City of Thark (illuminated apartments, inner chambers, domed roofs) and the Martian wilderness (mossy waste, hills, waterways). Characters are identified by their attire and species: Green Men (Thark warriors), Thoats (beasts used for transport), and specific weapons like strange Martian rifles and long-swords. The landscape features distinct Barsoom elements such as yellow moss, low mountains, and the absence of distant trees indicating lost direction.
