...
- timestamp_utc: 2026-04-20T02:16:02.598042+00:00
...
[[SECTION project_summary_markdown]]
# Project Summary: Mars Community & Narrator Integration

## Setting
The story takes place on Mars, specifically within a Martian community located near the crossing of two so-called Martian canals. The headquarters are in the southwest corner of a district bounded by fertile tracts. The environment includes subterranean vaults for egg storage and remote incubators built in fastnesses to avoid discovery by other tribes.

## Key Characters
- **Narrator:** An outsider integrated into Martian society, currently learning language and telepathy.
- **Sola:** A female Martian who acts as the narrator's guide and foster mother to a young male Martian. She cares for both the narrator and her offspring.
- **Tars Tarkas:** An enormous chieftain of the community, often seen explaining matters to the principal chieftain.
- **Lorquas Ptomel Jed:** The principal chieftain whose title is "jed." He oversees the incubator operations and child-raising ceremonies.

## Ongoing Plot Points
- The narrator is being trained in Martian conditions, including walking under gravity constraints and developing telepathic powers.
- A young male Martian (Sola's offspring) is being raised alongside the narrator. Sola's duties are doubled to care for both.
- The community practices a harsh system of child-rearing where young Martians are captured from incubators and raised by whoever catches them, with no concept of parental love or fathers.
- The narrator has mastered the Martian language within a week and can communicate needs effectively.

## Visual Continuity Facts
- **Chariots:** Three-wheeled vehicles, large and gorgeously decorated, drawn by single mastodonian animals without bit or bridle (guided telepathically).
- **Warriors:** Heavily armed men, women, and children riding in chariots.
- **Animals:** Heavy draft animals wear neither bit nor bridle; guided entirely by telepathic means.
- **Hounds:** Martian hounds accompany the narrator and warriors, following closely behind chariots.
- **Incubator:** Built in remote fastnesses, air-tight, hatched by sun's rays after five years.
- **Vaults:** Subterranean locations where eggs are kept before incubation, visited yearly by a council of twenty chieftains.
