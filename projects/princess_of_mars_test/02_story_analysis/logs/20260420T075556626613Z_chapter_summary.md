...
- timestamp_utc: 2026-04-20T07:55:56.627613+00:00
...
# Project Summary: The Princess of Mars Test

## Overview
This project documents the narrator's journey through the Martian hordes, capturing encounters with various warrior cultures including the Tharks and Warhoon. The narrative follows a first-person perspective as the protagonist experiences captivity, combat, and survival across multiple hostile environments.

## Key Elements
- **Setting**: Mars (Barsoom), featuring green-skinned warriors, thoats (Martian beasts), and ancient horde cities
- **Protagonist**: A captured outsider navigating deadly Martian societies
- **Themes**: Survival, captivity, cultural clash, violence, and escape
- **Structure**: Episodic encounters with different hordes, each revealing more about the narrator's resilience and the brutal nature of Martian society

## Reusable Context
This summary serves as a foundation for scene extraction across all chapters, maintaining consistency in describing the project's core narrative framework while allowing chapter-specific details to be added.
