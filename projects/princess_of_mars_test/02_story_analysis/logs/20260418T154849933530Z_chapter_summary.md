...
- timestamp_utc: 2026-04-18T15:48:49.933530+00:00
...
## Overview
The narrative follows John Carter, a human from Earth stranded on Mars, and his companion Sola navigating the landscape alongside Woola, a hound. The story centers on interactions with indigenous Green Martian warriors and conflicts involving advanced airship technology. The setting is a vast Martian environment featuring deserted cities, open valleys, and distant hills.

## Core Elements
- **Protagonists:** John Carter (human), Sola (companion), Woola (hound).
- **Antagonists/Factions:** Green Martians (warriors, females), Airship Fleet crews.
- **Setting:** Barsoom (Mars), characterized by deserted cities, plazas, and open plains.
- **Tone:** Adventure, warfare, exploration, and mystery regarding the nature of the inhabitants.
- **Themes:** Survival, cultural misunderstanding, and the clash between ancient Martian warriors and advanced aerial technology.

## Reusable Context
This summary establishes the baseline world state for subsequent chapters: John Carter is an observer and participant in Martian conflicts; Green Martians possess firearms and airships; Sola acts as a guide or companion; Woola accompanies Carter closely. Future scenes should maintain continuity regarding the geography (valleys, hills, city structures) and the visual identity of the factions (Green Martians vs. Gray Airships).
[[/SECTION]]
