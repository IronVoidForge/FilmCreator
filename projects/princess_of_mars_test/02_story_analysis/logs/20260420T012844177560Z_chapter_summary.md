...
- timestamp_utc: 2026-04-20T01:28:44.177560+00:00
...
## Context & Scope
This project covers the narrative arc of John Carter's imprisonment and survival within Thark society. The story focuses on the arena games as a primary mechanism for character development, combat demonstration, and plot progression toward escape.

## Key Locations
- **Thark City / Zodanga:** Underground urban environment, ancient ruins, plaza boundaries.
- **Underground Amphitheater:** Excavated below ground surface, filled with debris, seating capacity 20,000 Warhoons.
- **Hills East of City:** Escape route beyond the city limits.

## Key Characters
- **John Carter:** Protagonist, Red Martian (Helium), skilled swordsman.
- **Kantos Kan:** Fellow prisoner, Lieutenant in Helium Navy, brave explorer.
- **Dak Kova:** Thark leader, seated on raised platform with jeds and chieftains.
- **Warhoons:** Audience captors, green Martians, hordes of the city.
- **Green Warriors:** Enemies from northern hordes, often larger stature (16 feet).

## Key Props & Visual Elements
- **Long-swords:** Primary weapon for combat and staged death scenes.
- **Cages:** Holding captives before arena entry.
- **Calots:** Wild dogs used in contests.
- **Zitidars:** Ferocious beasts used in contests.
- **Daggers:** Given to female captives during initial games.

## Themes
- Survival and endurance under captivity.
- Martial prowess and agility.
- Strategic deception (staged death).
- Social hierarchy of the Tharks (games as sport).
[[/SECTION]]
