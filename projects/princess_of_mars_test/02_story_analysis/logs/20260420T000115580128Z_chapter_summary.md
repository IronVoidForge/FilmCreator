...
- timestamp_utc: 2026-04-20T00:01:15.580128+00:00
...
[[SECTION project_summary_markdown]]
The project is set on Mars, following a narrator who has undergone an incubation ceremony and arrived among the green Martians. Key characters include Sola (a companion), Woola (a hound), and Lorquas Ptomel (an old warrior). The narrative explores themes of interplanetary conflict, specifically involving air fleets and ground forces. A significant plot thread involves the capture of a female prisoner resembling Earth women by the green Martians following a naval engagement. The setting includes city structures, open valleys, and advanced Martian technology such as chariots, mastodons, and airships.
[[/SECTION]]
