...
- timestamp_utc: 2026-04-20T08:27:46.764857+00:00
...
## FilmCreator Tracking System

This document serves as a reusable summary for the FilmCreator tracking system, designed to maintain consistent metadata across all chapters of the Barsoom series adaptation. The system tracks key elements essential for scene extraction and narrative analysis.

### Core Purpose
- Maintain standardized project information across all chapter summaries
- Track character relationships and hierarchy within Martian society
- Document setting details including cities, fleets, and geographical features
- Record military engagements and their outcomes for later scene reconstruction

### Character Categories
- **Jeddaks**: Rulers of major territories (Helium, Thark)
- **Jeds**: Lower-ranking officers and warriors
- **Princesses**: Royal family members with significant political influence
- **Green Warriors**: Martian human fighters from various tribes
- **Tharks**: Green-skinned warriors with naval capabilities

### Setting Elements
- **Cities**: Helium (greater and lesser), Zodanga, Barsoom locations
- **Fleets**: Battleships, transports, cavalry units
- **Geography**: Ancient sea bottom, waterways, plains, palace grounds

### Tracking Priorities
1. Character introductions and relationships
2. Military engagements and outcomes
3. Political developments and alliances
4. Setting transitions and geographical movements

This project summary remains constant across all chapters to ensure consistent metadata structure for scene extraction workflows.
