...
- timestamp_utc: 2026-04-19T19:58:33.983690+00:00
...
[[SECTION project_summary_markdown]]
# Project Summary: A Princess of Mars Film Adaptation

## Overview
This is a film adaptation project based on Edgar Rice Burroughs' classic science fiction novel "A Princess of Mars" (also known as "John Carter of Mars"). The project follows the chapter-by-chapter structure of the original text, with each chapter representing a distinct scene or sequence in the narrative.

## Core Elements
- **Protagonist**: John Carter, an American Civil War veteran who has fallen through to Mars
- **Setting**: Barsoom (Mars), featuring ancient Martian cities, diverse Martians, and unique geography including dead seas, mountains, and table lands
- **Key Characters**: Tars Tarkas (vice-chieftain of the green Martians), Sola (young female Martian), various Martian warriors and chieftains
- **Themes**: Adventure, survival, cultural differences between humans and Martians, ancient civilizations

## Visual Style Notes
- Martian architecture features gleaming white marble with gold and brilliant stone inlays
- Martians are described as green-skinned creatures ranging from 8-12 feet tall
- Ancient buildings show evidence of long-extinct races predating current Martians
- The world combines advanced ancient technology with primitive Martians

## Adaptation Approach
The project maintains fidelity to the original text's chapter structure while creating visual continuity across scenes. Each chapter summary provides specific decomposition points for scene breakdown without requiring re-reading of the full chapter.
