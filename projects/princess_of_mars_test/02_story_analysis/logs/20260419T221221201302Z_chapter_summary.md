...
- timestamp_utc: 2026-04-19T22:12:21.201302+00:00
...
[[SECTION project_summary_markdown]]
# Project Summary: A Princess of Mars (Chronicle Edition)

**Narrative Frame:** First-person chronicle written by John Carter ("Captain Jack Carter") after his death. The manuscript is intended for future readers to understand the mysteries of Mars.

**Core Premise:** An immortal soldier recounts the transition from Civil War veteran to explorer. The narrative begins in Virginia and Arizona, establishing a backstory that leads into Martian adventures.

**Key Characters:**
- **John Carter:** Narrator. Claims immortality (died twice). Former Confederate Captain.
- **James K. Powell:** Mining engineer friend. Victim of the opening ambush.

**Setting Arc:**
1.  Virginia (Civil War context)
2.  Arizona Hills (Gold prospecting)
3.  Remote Cave Entrance (Transition point to unknown territory)

**Visual Continuity Baseline:**
- **Landscape:** Arizona terrain (hills, valleys, plateaus, gorges). Moonlight scenes dominate the chase sequence.
- **Gear:** Burros, horses, Colt revolvers, carbine, cartridge belts.
- **Tone:** Reflective, tense, adventurous.

**Reusable Context:** Future chapters will expand on Carter's "immortality," the specific mechanics of the cave interior, and the transition from Earth to Mars. This summary establishes the narrator's voice and the initial setting shift required for subsequent scene extraction.
[[/SECTION]]
