...
- timestamp_utc: 2026-04-20T03:54:34.556907+00:00
...
[[SECTION project_summary_markdown]]
**Setting:** Barsoom (Mars), ancient civilization featuring grand architecture, waterways/canals, red sun/moons, and distinct community divisions (jeds, warriors).
**Characters:** John Carter (Dotar Sojat), Dejah Thoris (captive of Thark), Tal Hajus (Jeddak of Thark), Sola (Thark woman), Sarkoja (antagonist).
**Locations:** Korad, Thark (city and plaza), Helium (destination), Tal Hajus territory.
**Context:** John Carter is a captive in Thark alongside Dejah Thoris. They are planning an escape to Helium. The society involves arena games, strict customs, and political intrigue between Jeddaks and Sarkoja.
[[/SECTION]]
