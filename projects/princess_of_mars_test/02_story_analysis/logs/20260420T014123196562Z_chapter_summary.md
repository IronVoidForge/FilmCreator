...
- timestamp_utc: 2026-04-20T01:41:23.196562+00:00
...
[[SECTION project_summary_markdown]]
Project adapts Edgar Rice Burroughs' "Princess of Mars" for live-action. Setting is Barsoom (Mars), featuring distinct Martian geography and technology. Key locations include Helium (red towers) and Zodanga (yellow/scarlet). Narrative centers on John Carter (Kantos Kan), Tars Tarkas, and Dejah Thoris. Core conflict involves interplanetary warfare between Thark warriors and Martian factions. Visual continuity requires accurate depiction of sky ships, green Martian warriors, and thoats (beasts). Tone is epic adventure with political intrigue and romantic subplots.
[[/SECTION]]
