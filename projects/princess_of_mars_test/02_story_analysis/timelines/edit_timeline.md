...
- dialogue_events: `0`
- estimated_duration_seconds: `25`
- transition_note: From awareness/confusion to helpless terror and sensory isolation. **Likely Visual Coverage Families:** - Extreme Clo...
...
- dialogue_events: `0`
- estimated_duration_seconds: `25`
- transition_note: Confusion $\rightarrow$ Physical Bewilderment/Surprise. **Likely Visual Coverage Families:** - Wide shots of the Mart...
...
- transition_note: Awe/Trepidation $\rightarrow$ Alienation. **Likely Visual Coverage Families:** * Extreme Wide Shots (EWS) to establis...
...
- transition_note: Isolation/Curiosity $\rightarrow$ Comfort/Observation. **Likely Visual Coverage Families:** - Close-ups of the protag...
...
- dialogue_events: `0`
- estimated_duration_seconds: `20`
- transition_note: Terror $\rightarrow$ Desperation $\rightarrow$ Fierce Loyalty. **Likely Visual Coverage Families:** - Tight close-ups...
...
- transition_note: Awe and intimidation at the sheer scale of the Martian military force. **Likely Visual Coverage Families:** - Wide es...
...
- scene_count: `5`
- dialogue_events: `24`
- estimated_duration_seconds: `97`
- transition_note: From testing/uncertainty to profound mutual connection/loyalty. **Likely Visual Coverage Families:** - Close-ups on C...
...
- transition_note: From wary respect to intense political pressure and threat. **Likely Visual Coverage Families:** * Medium shots of th...
...
- transition_note: From struggle/tension (taming the beasts) to triumph and communal respect. **Likely Visual Coverage Families:** - Wid...
...
- transition_note: Relief (from survival) to Melancholy (observing Dejah's grief). **Likely Visual Coverage Families:** - Close-ups on C...
...
- transition_note: Terror/Despair $\rightarrow$ Sudden Action $\rightarrow$ Relief. **Likely Visual Coverage Families:** - Close-ups on...
...
- transition_note: Confusion/Pain $\rightarrow$ Helplessness/Dread. **Likely Visual Coverage Families:** - Extreme close-ups of eyes ope...
...
- transition_note: Confusion $\rightarrow$ Realization of entrapment/Danger. **Likely Visual Coverage Families:** - Close-ups on Carter'...
...
- transition_note: Hope/Anticipation $\rightarrow$ Devastation/Betrayal. **Likely Visual Coverage Families:** - POV shots from behind th...
...
- transition_note: From ceremonial tension and dread to shock, chaos, and sudden heroic intervention. **Likely Visual Coverage Families:...
...
- dialogue_events: `11`
- estimated_duration_seconds: `53`
- transition_note: Confusion $\rightarrow$ Horror/Dread **Likely Visual Coverage Families:** - Extreme close-ups of eyes/breathing (diso...
