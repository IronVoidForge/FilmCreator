...
# Purpose
Establish background conflict action via prisoner dragging motion while maintaining foreground corridor context; create visual contrast between emotional connection in foreground and desperate state in background without interrupting flow.

# Workflow Type
video.cut_motion.wan.i2v

# Positive Prompt
Exterior corridor depth view, static foreground reference, slender human female prisoner moving right to left in background, dragging motion evident, daylight lighting with smoke haze, distant hills visible beyond corridor opening, Green Martian females pulling prisoner through view, fire glow from burning ship in distance, medium background shot composition.
...
- look_continuity_policy: Maintain keyframe lighting and grade from CL003. Ensure prisoner moving right-to-left in background without foreground interruption. Keep corridor depth static. Match fire glow intensity from burning ship.
...
- anatomy_repair_policy: Check anatomy of dragging figures.
