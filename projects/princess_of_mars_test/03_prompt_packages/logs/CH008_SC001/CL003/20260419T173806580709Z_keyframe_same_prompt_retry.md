...
- timestamp_utc: 2026-04-19T17:38:06.580709+00:00
- stage: keyframe
- clip_id: CL003
...
[[SECTION purpose]]
Capture the visible state of gray-painted vessels descending into frame from northern horizon against clear sky. Freeze the moment of coordinated approach along horizon line.
[[/SECTION]]

[[SECTION positive_prompt]]
Extreme long shot view of open sky and distant horizon, multiple gray-painted vessels descending into frame from northern direction, horizontal axis aligned with horizon line, daylight exterior lighting illuminating scene, figures crowding forward decks visible on hulls, high contrast between bright sky and dark vessel hulls, static hold framing on initial fleet approach.
[[/SECTION]]

[[SECTION negative_prompt]]
Human skin tone, interior shadows, doorway threshold, building architecture, crowded plaza, distorted anatomy, blurry text, low resolution, modern clothing, weapons visible on protagonist, static pose, fully visible faces (unless specified), bright interior lighting, green-skinned figures on deck (if not intended for this specific keyframe start).
[[/SECTION]]
...
- clip_id: CL003
- duration_seconds: 5
- workflow_type: still.scene_build.f
````
