...
- timestamp_utc: 2026-04-19T17:31:57.017603+00:00
- stage: scene_stage
- clip_id: CL002
- retry_kind: normal
...
[[SECTION purpose]]
Establish visual staging for medium group shot from John Carter's upper floor window perspective showing Green Martians retreating towards eastern sector. Focus on coordinated movement and formation consistency. Capture the retreat trajectory from city perimeter to eastern valley. Frame should show city buildings and open ground plaza for geographic continuity. The opening keyframe intent is to show Martians at city perimeter ready for engagement, then movement begins during clip duration. This sets stage for coming conflict between Green Martians and Air Fleet (though fleet is not in this shot).
[[/SECTION]]

[[SECTION positive_prompt]]
Medium group shot from upper floor window perspective, Green Martians retreating towards eastern sector, coordinated movement maintaining formation, green skin visible, ornaments on bodies, spears carried, city perimeter as visual anchor, open ground plaza below visible, valley beyond maintaining geographic continuity, daylight lighting, dust kicked up by retreating troops visible, anticipation building atmosphere, John Carter observer POV eyeline directed downward toward city boundary, vertical axis from upper floor to ground level.
[[/SECTION]]

[[SECTION negative_prompt]]
Close-up facial details, indoor setting only, night time, static pose, wrong faction colors (non-green skin), forward progression into valley terrain, sudden halt or reverse movement within clip duration, blurred background, incorrect character count, missing dust continuity, abrupt cuts breaking continuity, Carter position inconsistent in window frame.
[[/SECTION]]
...
- optional_refs: CH008_SC001_clip_roster
- visible_character_assets: Green Martians in formation (green skin, ornaments, spears)
- look_continuity_policy: maintain movement consistency and dust continuity
- intended_lighting_change: daylight consistent with establishing shots
- composition_type: medium_group_shot_from_window_pov
- continuity_mode: cutaway
- starting_keyframe_strategy: static_hold_martians_at
````
