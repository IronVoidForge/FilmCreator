...
- timestamp_utc: 2026-04-18T21:16:17.884261+00:00
- stage: cut_motion
- clip_id: CL006
- retry_kind: normal
...
Describe the cut beat, framing, and continuity intent for this clip. Maintain banner and device design continuity while transitioning from fleet-wide view to individual ship prow detail perspective. Preserve daylight grade and window frame consistency from previous clips.
...
twenty gray airships form wide formation over hill crests, strange banners visible on prows, odd devices mounted on vessels, narrator eyeline shifts from fleet distribution to individual ship details, camera slowly pushes forward, focus axis moves from horizontal fleet positioning to vertical prow elements, sunlight brightens midday exterior, smoke rises from burning vessel in background, green figures minimal movement on selected ships, hill crests provide depth context for close-up examination
...
distorted faces, extra limbs, flickering lights, dark shadows, night time, blurry motion, inconsistent anatomy, text overlays, watermark, morphing artifacts, banner design changes, device shape inconsistencies, ship count variations, interior lighting shifts, warm grade deviations, facial expression shifts too fast, unmanned vessel appearance, wrong character assets
...
- duration_seconds: 5
- required_refs: 
- optional_refs: hill crests depth context, lighting consistency notes, interior lighting level warm contrast from CL001
- visible_character_assets: green warriors static on selected vessels, narrator eyeline available for detail shifts
- look_continuity_policy: banner designs identifiable across shots, device shapes continuity markers, ship prow details visible in frame
- intended_lighting_change: daylight transitions maintain midday brightness consistency
- composition_type: cutaway_detail
...
- consistency_assist_method: 
- anatomy_repair_policy: 
- consistency_targets: ship positions relative to hill crests, banner visibility, window framing elements, interior lighting level
...
- Daylight transitions maintain bright midday exterior consistency
- Fleet formation and positioning consistency maintained across hill crests
- Banner designs must be identifiable in close-up examination shots
- Device shapes establish continuity markers visible in frame
- Ship count of twenty maintained in wide formation shots
- Hill crest depth context preserved for close-up perspective
...
- Ensure ship count remains consistent in background across all frames
- Correct lighting shift if grade deviates from daylight consistency
- Verify banner designs stay identifiable when focus moves to individual ships
- Check device shapes maintain continuity markers throughout clip duration
- Prevent warm interior lighting from bleeding into exterior daylight shots
