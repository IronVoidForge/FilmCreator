...
- timestamp_utc: 2026-04-18T21:14:27.746014+00:00
- stage: scene_stage
- clip_id: CL006
- retry_kind: normal
...
Describe staging intent for scene stage clip within upper floor observation sequence establishing narrator investigation of Martian fleet retreat from observation point perspective with continuity markers maintained across shots including ship count, banner designs, device shapes, and window framing elements

[[/SECTION]]

[[SECTION positive_prompt]]

Earth human male standing at upper floor window observing distant formation of twenty gray airships over hill crests in daylight conditions, polished stone floor visible inside room, dark wood window frame with metal accents profile view facing outward, strange banners on ship prows visible in distance, odd devices mounted on vessel prows identifiable in close examination, warm interior lighting contrasting cool exterior daylight, hill crests providing depth reference points for ship positioning

[[/SECTION]]

[[SECTION negative_prompt]]

night scene, indoor artificial lighting only, different character attire than Earth human, crowded street level inside window view, modern technology props on ships, incorrect fleet formation count, dark wood frame missing metal accents, close up facial expressions only without eyeline movement, cold blue exterior lighting, interior lacking warm contrast to exterior
...
- visible_character_assets: Earth human protagonist, Green Warriors static or minimal movement on selected vessels with visible banners and devices
- look_continuity_policy: window frame consistent across shots
- intended_lighting_change: morning to midday transition maintaining warm interior cool exterior contrast
...
- consistency_assist_method: visual reference markers on banners and devices
- anatomy_repair_policy: ensure Earth human proportions consistent with previous clips
- consistency_targets: window frame elements, ship positions relative to hill crests, interior lighting level
- style_profile: action oriented sci-fi adventure
- batch_role: continuity detail shot
- fix_of: SC001_CL006_fix_01_prompt

[[/SECTION]]

[[SECTION continuity_notes_markdown]]

- Earth human maintains consistent distance from window frame across shots
- Window wiper position remains unchanged for continuity between clips
- Fleet approaches in steady formation with angle toward plaza maintained
- Lighting shifts from soft morning to brighter midday while preserving warm interior cool exterior contrast
- Floor material remains consistent polished stone tiles visible inside room
- Ship count of twenty must be maintained in wide shots over hill crests
- Banner designs must be identifiable across shots for continuity markers
- Device shapes on ship prows establish visual reference points between clips
- Window framing and interior elements must stay consistent throughout sequence

[[/SECTION]]

[[SECTION repair_notes_markdown]]

- Ensure Earth human hand placement on window sill varies by emotional beat while maintaining position consistency
- Verify fleet formation consistency across shots with hill crest depth references
- Match daylight continuity conditions accurately between morning and midday transition
- Check for any visible props or devices on ships matching visual notes from banner designs
- Confirm interior lighting level warm contrast to exterior cool daylight maintained throughout clip
- Ensure ship positions relative to hill crests remain consistent for continuity markers
