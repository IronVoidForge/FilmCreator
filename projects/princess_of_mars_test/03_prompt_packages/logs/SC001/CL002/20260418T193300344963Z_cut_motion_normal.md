...
- timestamp_utc: 2026-04-18T19:33:00.344963+00:00
- stage: cut_motion
- clip_id: CL002
- retry_kind: normal
...
{
  "purpose": "Execute cut motion transition following fleet descent from hill crest to city approach while maintaining spatial continuity from observation point.",
  "positive_prompt": "Tracking shot following twenty gray airships descending from distant hill crest toward deserted city streets. Fleet forms pattern across sky with banners and gleaming prows. Golden hour sunlight highlights devices. Carter and Sola visible in foreground observing fleet movement. Camera maintains eye-level perspective. Ships swing slowly over the crest of the nearest hill.",
  ...
  "inputs": {
    ...
    "clip_id": "CL002",
    "duration_seconds": "5",
    "visible_character_assets": "Carter, Sola",
    "composition_type": "Tracking Shot",
    "continuity_mode": "continuous_follow",
    "starting_keyframe_strategy": "motion_opening",
  ...
  "continuity_notes": [
    "Preserve the keyframe lighting and grade by default.",
    "Focus on visible motion, camera behavior, and environment change.",
    "Start from fleet halfway over hill crest.",
    "Maintain spatial continuity from previous clip.",
    "Fleet approaches in steady formation with 15-degree angle toward plaza."
  ],
  "repair_notes": [
