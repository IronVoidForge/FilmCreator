...
- timestamp_utc: 2026-04-18T21:04:17.279226+00:00
- stage: keyframe
- clip_id: CL002
- retry_kind: normal
...
Establish full scale of twenty gray air ships positioned at base of first hill crest, showing retreat formation from elevated observation point with distant fleet pattern across horizon and mechanical devices visible on prows
...
elevated stone observation platform, single human observer in profile view, twenty gray-painted airships forming coordinated pattern across hill crests, deserted urban rooftop network below, valley vista stretching southward, morning sunlight illuminating sky, fleet positioned at base of first hill crest, mechanical devices gleaming on prows, banners visible on ship prows
...
interior corridor, close-up facial features, crowd of civilians, fire, smoke, burning vessel, prisoner figure, distorted anatomy, blurry focus, text, watermark, low resolution, extra limbs, missing weapons, chariots, mounted warriors, air craft with guns, green figures dropping at bullet explosions
...
- clip_id: CL002
- duration_seconds: 5
- required_refs: BT001.md and BT002.md
...
- visible_character_assets: human male observer from upper floor
- look_continuity_policy: motion_opening
- intended_lighting_change: golden hour sunlight
...
- consistency_assist_method: literal descriptive markers
- anatomy_repair_policy: fix any distortions on observer figure
- consistency_targets: ship positions relative to hill crests, banner designs, window frame details
...
- Ensure distant ships are clearly defined against horizon
- Verify window frame details match continuity
- Maintain ship count consistency across shots
- Ensure banner visibility markers are clear in wide shots
- Check interior lighting level contrast between warm and cool zones
