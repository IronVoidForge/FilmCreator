...
- timestamp_utc: 2026-04-18T21:08:41.115941+00:00
- stage: scene_stage
- clip_id: CL004
- retry_kind: normal
...
Define staging intent and subject placement for Scene SC001 Clip CL004, focusing on close-up examination of banner designs and devices on ship prows while maintaining visual continuity with previous beats regarding lighting and composition from upper floor window perspective.
...
Close-up shot of strange banners attached to gray airship prows. Intricate geometric patterns visible on fabric material. Odd mechanical devices mounted on ship front edges. Green warrior figures static or minimal movement in background of frame. Upper floor window frame edge visible in foreground corner. Midday sunlight casting sharp reflections on metallic device surfaces. Hill crests providing depth context behind ships. Atmosphere mysterious and sci-fi adventure tone.
...
- clip_id: CL004
- duration_seconds: 5
- required_refs: beat bundle BT003 detail focus notes, chapter summary daylight conditions
- optional_refs: medium shot narrator plus fleet in frame, POV from narrator looking at approaching ships
- visible_character_assets: green warrior figures on selected vessels, human male narrator eyeline presence
- look_continuity_policy: Match interior daylight from previous clips
- intended_lighting_change: Consistent with BT003 window view beat
- composition_type: close-up shot of banner designs
- continuity_mode: midday light established
...
- workflow_type: authoring.scene_stage
- beat_index: BT003
- environment_context: upper floor window, hill crests, ship prows
- lighting_condition: midday sunlight reflecting off ship devices
