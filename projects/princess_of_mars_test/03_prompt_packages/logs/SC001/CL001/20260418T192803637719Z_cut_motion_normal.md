...
- timestamp_utc: 2026-04-18T19:28:03.637719+00:00
- stage: cut_motion
- clip_id: CL001
- retry_kind: normal
...

{
  ...
  "positive_prompt": "Two observers stand on elevated platform edge facing outward. Male warrior left side, female companion right side. Both gaze toward distant hill crest where gray airships form fleet. Fleet begins descending motion over hill ridge. Banners stem to stern readable in sunlight. Prow devices gleam with highlights. Camera holds steady then slight forward track following ships. Daylight sunlight reflects off ship surfaces. Cinematic grade preserved.",
  "negative_prompt": "morphing artifacts, flickering lighting, wrong anatomy, extra characters, sudden crowd appearance, incorrect camera angle, distorted background, inconsistent grade, blurry motion, static frame, low resolution, green warriors appearing prematurely, interior shadows conflicting with exterior light",
  "inputs": {
    "project_id": "princess_of_mars_test",
    "scene_id": "SC001",
    "clip_id": "CL001",
    ...
    "required_refs": "BT001.md, Scene SC001 breakdown",
    "optional_refs": "Procession garment details, plaza distance markers",
    "visible_character_assets": "male warrior observer at platform edge, female companion observer beside him",
    "look_continuity_policy": "preserve_keyframe_lighting",
    "intended_lighting_change": "none",
    "composition_type": "wide_shot_observation",
    "continuity_mode": "platform_consistent",
    "starting_keyframe_strategy": "establish_vertical_axis_elevated_observer",
    "dependency_policy": "none_standalone_opening_shot",
    "auto_advance_policy": "standard",
    "fallback_strategy": "use_static_wide_if_zoom_unavailable",
    ...
    "consistency_assist_method": "interval_frames",
    "anatomy_repair_policy": "enabled",
    "consistency_targets": "narrator_position,
````
