...
- timestamp_utc: 2026-04-18T19:28:56.621410+00:00
- stage: cut_motion
- clip_id: CL001
...
{
  "purpose": "Generate cut motion starting from approved opening frame, preserving keyframe lighting and grade, focusing on visible motion, camera behavior, and environment change.",
  "positive_prompt": "Human male observer stands at dark wood window sill inside upper floor room. Medium profile shot three-quarter angle facing outward. Hands resting on polished stone window ledge. Slight head tilt right toward distant horizon where gray airships form fleet in valley. Fleet swings slowly over hill crest, banners stem-to-stern readable. Prow devices gleam in sunlight. Dust motes drift inside room. Cinematic grade preserved.",
