...
- timestamp_utc: 2026-04-19T19:33:59.309421+00:00
- stage: scene_stage
- clip_id: CL005
...
[[SECTION purpose]]
Establish emotional anchor through eye contact between observer figure and captive figure; show protagonist's reaction to captive's state in background movement; medium shot composition with both figures visible for connection.
[[/SECTION]]

[[SECTION positive_prompt]]
Observer figure face and upper body in foreground, eyes focused on captive figure in background, Martian city buildings with windows and roofs, daylight atmosphere, open ground plaza area, partial visibility of slender girlish figure with light reddish copper skin, coal black hair caught loosely into strange coiffure, highly wrought ornaments visible, green Martian warriors firing from buildings in distance, smoke from fire effects, missile impact flames spurt.
[[/SECTION]]

[[SECTION negative_prompt]]
full body shots, other characters entering frame, excessive camera movement, close-up only on eyes, wide shot showing entire city, night lighting, indoor corridor setting, no captive figure visible, green Martian females dragging captive figure, air craft in foreground, explosion effects dominating frame.
[[/SECTION]]
...
- required_refs: CH008_SC005/BEAT_INDEX.md BT003, CH008_SC005/BT003.md Start State
- optional_refs: None
- visible_character_assets: observer figure (face and upper body), captive figure (background, partial visibility)
- look_continuity_policy: reblock_same_scene
- intended_lighting_change: daylight with smoke from fire
- composition_type: Medium shot, both observer figure and captive figure in frame for eye contact
- continuity_mode: reblock_same_scene
- starting_keyframe_strategy: Static frame showing observer figure's face locked on captive figure's background movement
- dependency_policy: Depends on CL004 establishing conflict context; no reverse dependency
- auto_advance_policy: None
- fallback_strategy: If eye contact unclear, tighten to close-up on observer figure's eyes or widen to show more of captive figure's expression
- consistency_assist_policy: None
- consistency_assist_method: None
- anatomy_repair_policy: None
- consistency_targets: Eye contact clarity, character identification
...
[[SECTION continuity_notes_markdown]]
- Capture the continuity rules for this stage. Maintain eye line between observer figure and captive figure throughout clip duration. Keep background movement consistent with previous shots showing captive figure being dragged into building. Ensure lighting matches daylight conditions with fire smoke effects from previous battle sequence. Character identification must remain clear - observer figure as witness, captive figure as prisoner with distinctive reddish copper skin and coal black hair.
[[/SECTION]]

[[SECTION repair_notes_markdown]]
- Capture any repair or corrective guidance for this stage. If eye contact is not clearly established in initial render, tighten framing to close-up on observer figure's eyes while maintaining background visibility of captive figure. If captive figure becomes too obscured by environment, widen shot slightly to show more of her upper body and distinctive features. Ensure no other characters enter frame during this emotional anchor moment.
[[/SECTION]]
