...
- timestamp_utc: 2026-04-19T19:30:04.298066+00:00
- stage: cut_motion
- clip_id: CL003
...
# Positive Prompt
observer protagonist upper body close up, female companion face urgent expression, eyes focused forward then locking with observer protagonist, daylight lighting, smoke haze background, slight camera static frame on face, micro-expression shift showing determination, green skin tone ornaments visible, building entrance threshold environment, fire smoke particles drifting, high contrast shadows from urgency, cinematic grade action oriented.
...
- clip_id: CL003
- duration_seconds: 5
- required_refs: projects/princess_of_mars_test/02_story_analysis/beat_bundles/CH008_SC005/BEAT_INDEX.md, projects/princess_of_mars_test/02_story_analysis/beat_bundles/CH008_SC005/BT003.md
- optional_refs: None
- visible_character_assets: observer protagonist (face, eyes, upper body), female companion (face, eyes, ornaments)
