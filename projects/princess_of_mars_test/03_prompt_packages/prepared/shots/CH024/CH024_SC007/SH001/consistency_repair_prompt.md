...
# ID
CH024_SC007_SH001_consistency_repair_prompt
...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Strategic intensity and readiness for war.. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with placed for immediate spatial orientation.. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial co...
...
- composition: Wide composition across Zodanga (atop walls/near gates) with john_carter placed for immediate spatial orientation.
