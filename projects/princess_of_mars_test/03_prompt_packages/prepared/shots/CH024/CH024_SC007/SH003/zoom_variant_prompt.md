...
# ID
CH024_SC007_SH003_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Strategic intensity and readiness for war.. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of land the scene consequence or transition cleanly... Characters: described character with stable costume and silhouette. Environment: described environment with stable spati...
...
- composition: Closing composition in Zodanga (atop walls/near gates) that emphasizes the consequence of land the scene consequence or transition cleanly..
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH024\CH024_SC007\SH003\DIALOGUE.json
