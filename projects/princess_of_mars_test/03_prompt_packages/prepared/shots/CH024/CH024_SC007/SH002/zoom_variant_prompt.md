...
# ID
CH024_SC007_SH002_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Strategic intensity and readiness for war.. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: described character with stable costume and silhouette, . Environment: described environment with stable spatial continuity. Keep continuity exact across costume, silhouette,...
...
- composition: Readable medium composition in Zodanga (atop walls/near gates) featuring john_carter, Infiltration Team.
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH024\CH024_SC007\SH002\DIALOGUE.json
