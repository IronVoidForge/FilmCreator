...
# ID
CH024_SC004_SH004_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Defiance $\rightarrow$ High Tension $\rightarrow$ Victory/Ascension.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], unknown. Environment: described environment with stable spatial continuity. Keep continui...
...
- composition: Dynamic composition in Thark (Council Chamber) with tars_tarkas, john_carter crossing the frame and maintaining readable movement.
- prompt_family: shot_prompt
- reference_asset_ids: tars_tarkas; john_carter
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH024\CH024_SC004\SH004\DIALOGUE.json
