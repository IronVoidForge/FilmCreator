...
- composition: Dynamic composition in audience_chamber with john_carter crossing the frame and maintaining readable movement.
- prompt_family: shot_prompt
- reference_asset_ids: john_carter; audience_chamber
