...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Terror/Despair $\rightarrow$ Sudden Action $\rightarrow$ Relief. **Likely Visual Coverage Families:** - Close-ups on Tal Hajus's cruelty.... Stable medium framing that keeps action and character readable.. Readable medium composition in featuring .. Characters: [], unknown. Environment: described environment with stable spatial continu...
...
- composition: Readable medium composition in The City of Thark (circular halls/raised platforms) featuring dejah_thoris.
