...
# ID
CH017_SC001_SH004_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Terror/Despair $\rightarrow$ Sudden Action $\rightarrow$ Relief. **Likely Visual Coverage Families:** - Close-ups on 's cruelty and Dejah.... Stable medium framing that keeps action and character readable.. Readable medium composition in featuring .. Characters: [], unknown. Environment: described environment with stable spatial contin...
...
- composition: Readable medium composition in The City of Thark (circular halls/raised platforms) featuring tal_hajus.
- prompt_family: shot_prompt
- reference_asset_ids: tal_hajus
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH017\CH017_SC001\SH004\DIALOGUE.json
