...
# ID
CH017_SC002_SH003_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Relief $\rightarrow$ Desperation/Exhaustion.. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of land the scene consequence or transition cleanly... Characters: described character with stable costume and silhouette. Environment: described environment with stable spa...
...
- composition: Closing composition in The Mossy Waste (vast, trackless, desolate) that emphasizes the consequence of land the scene consequence or transition cleanly..
