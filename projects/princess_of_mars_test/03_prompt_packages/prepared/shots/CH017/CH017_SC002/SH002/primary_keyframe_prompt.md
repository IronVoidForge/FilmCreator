...
# ID
CH017_SC002_SH002_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Relief $\rightarrow$ Physical Exhaustion/Desperation. **Likely Visual Coverage Families:** - Wide shots of the vast, empty landscape to e.... Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: [], unknown. Environment: described environment with stable sp...
...
- composition: Readable medium composition in The Mossy Waste (desolate, trackless expanse) featuring john_carter, dejah_thoris.
