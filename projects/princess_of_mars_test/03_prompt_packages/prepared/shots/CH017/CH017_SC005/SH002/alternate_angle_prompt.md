...
# ID
CH017_SC005_SH002_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Heroic Defiance $\rightarrow$ Panic/Desperation $\rightarrow$ Total Defeat.. Active camera with tracking energy and clear spatial orientation.. shifted perspective with preserved subject spacing. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. Keep c...
