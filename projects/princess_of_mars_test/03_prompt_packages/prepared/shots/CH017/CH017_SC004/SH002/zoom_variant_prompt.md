...
# ID
CH017_SC004_SH002_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Dread $\rightarrow$ Decisiveness $\rightarrow$ Heartbreak (during the farewell).. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. Keep continui...
...
- composition: Readable medium composition in The Mossy Waste near a mountain pass featuring protagonist, dejah_thoris.
