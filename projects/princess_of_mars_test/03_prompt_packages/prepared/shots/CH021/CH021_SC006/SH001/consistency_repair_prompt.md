...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Tension $\rightarrow$ Triumph/Grandeur.. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with placed for immediate spatial orientation.. Characters: [], No visual data available., unknown. Environment: described environment with stable spatial continuity. Keep cont...
...
- composition: Wide composition across Zodanga Central Plaza (ceremonial setting) with zodangan_scout placed for immediate spatial orientation.
- prompt_family: shot_prompt
- reference_asset_ids: zodangan_scout
