...
# ID
CH021_SC006_SH005_consistency_repair_prompt
...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Tension $\rightarrow$ Triumph/Grandeur.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with crossing the frame and maintaining readable movement.. Characters: [], No visual data provided in the evidence., unknown. Environment: described environment with stable spa...
