...
# ID
CH021_SC002_SH004_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Determination $\rightarrow$ Melancholy/Heartbreak.. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of the emotional parting between carter and occurs... Characters: [], No visual description is provided in the available evidence., unknown. Environment: described env...
