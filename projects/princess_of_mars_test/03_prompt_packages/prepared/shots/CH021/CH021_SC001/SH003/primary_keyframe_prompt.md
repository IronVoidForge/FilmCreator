...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Wonder (at technology) $\rightarrow$ Tension (political discourse).. Shoulder-level conversational framing with visible foreground presence.. balanced framing with clear spatial separation. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. K...
