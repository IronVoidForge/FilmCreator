...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Wonder (at technology) $\rightarrow$ Tension (political discourse).. Shoulder-level conversational framing with visible foreground presence.. tighter framing on the same moment. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. Keep continuity exact acros...
