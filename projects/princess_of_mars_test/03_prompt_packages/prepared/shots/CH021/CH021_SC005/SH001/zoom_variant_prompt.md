...
# ID
CH021_SC005_SH001_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Tension $\rightarrow$ High Action $\rightarrow$ Relief.. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with, placed for immediate spatial orientation.. Characters: [], unknown, [], No visual data available., unknown. Environment: described environment with stable spatial continuity. Keep contin...
...
- composition: Wide composition across The Martian sky/aerial combat zone with john_carter, zodangan_scout placed for immediate spatial orientation.
- prompt_family: shot_prompt
- reference_asset_ids: john_carter; zodangan_scout
