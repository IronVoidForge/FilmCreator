...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Tension $\rightarrow$ High Action $\rightarrow$ Relief.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], unknown, [], No visual data available., unknown. Environment: described environment with stable spatial continuit...
...
- composition: Dynamic composition in The Martian sky/aerial combat zone with john_carter, zodangan_scout crossing the frame and maintaining readable movement.
