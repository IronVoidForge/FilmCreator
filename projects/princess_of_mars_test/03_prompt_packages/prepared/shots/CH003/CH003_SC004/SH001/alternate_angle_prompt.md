...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the identity reference for the secondary visible subject. Use image3 as the environment reference for the scene location. Alternate angle with the same beat and preserved continuity.. A desperate escape via a massive thirty-foot leap across a mossy circular basin.. The subject from image1 is described character with stable costume and silhouette, foreground entry line within incubator zone, jump distance dwarfs martian_warriors scale, front three-quarter right toward the scene action, protagonist cornered against low wall. The subject from image2 is described character with stable costume and silhouette, protagonist plays against martian_warriors in same frame. Preserve described environment with stable spatial continuity from image3, especially low walled enclosure. proximity to walls vs warriors. medium-full, low angle, wide lens, push in, shallow subject, diffuse ambient. Wide composition across with and placed for spatial orientation.. protagonist prepares for the jump. incubator zone. Keep continuity exact across costume, silhouette, lighting, and spatial relationships.. Avoid proper nouns in the prompt body unless text is meant to appear on screen.. No text, no watermark, no logo.
...
- composition: Wide composition across circular_moss_basin with protagonist and martian_warriors placed for spatial orientation.
