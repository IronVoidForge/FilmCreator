...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the identity reference for the secondary visible subject. Use image3 as the environment reference for the scene location. Alternate angle with the same beat and preserved continuity.. An unarmed leader offers a metal token to a protagonist in a yellowish mossy basin.. The subject from image1 is described character with stable costume and silhouette, midground inside martian_distant_hills, protagonist height on mount, rear three-quarter left away from camera, Protagonist being lifted. The subject from image2 is described character with stable costume and silhouette, protagonist plays against martian_warriors and The Leader in the same frame. Preserve described environment with stable spatial continuity from image3, especially martian_distant_hills. protagonist height on mount. wide, low angle, ultra-wide lens, track, deep focus, diffuse ambient. Wide composition across with, and for spatial orientation.. Protagonist is lifted onto a mount and the group rides away. Keep continuity exact across costume, silhouette, lighting, and spatial relationships.. Avoid proper nouns in the prompt body unless text is meant to appear on screen.. No text, no watermark, no logo.
...
- camera_description: Wide establishing frame with a steady or light tracking motion.
- composition: Wide composition across martian_distant_hills with protagonist, martian_warriors, and The Leader for spatial orientation.
- shot_size: wide
