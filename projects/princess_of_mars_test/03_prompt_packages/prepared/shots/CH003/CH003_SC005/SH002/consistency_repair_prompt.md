...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the environment reference for the scene location. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships. An unarmed leader offers a metal armlet to a transformed human in a yellowish moss basin. The subject from image1 is protagonist, foreground inside yellowish moss basin, The physical height difference between the protagonist and the Martian mount during the lift, facing directly toward camera, hand reaching out. Preserve the environment from image2 especially yellowish moss basin. Keep one readable subject anchor: hand reaching out. close-up, eye level, portrait lens, locked off, zoom subtle in, shallow subject, diffuse ambient. Intimate composition that isolates and against to capture the beat's emotional turn. Protagonist accepts the metal armlet. yellowish moss basin. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo
...
- composition: Intimate composition that isolates protagonist and The Leader against circular_moss_basin to capture the beat's emotional turn.
- shot_size: close_up
