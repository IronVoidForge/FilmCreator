...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Desperation $\rightarrow$ Rage/Combat Intensity. **Likely Visual Coverage Families:** - Wide shots to establish the geography of the figh.... Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], unknown, . Environment: desc...
...
- composition: Dynamic composition in Palace corridors/Antechambers with john_carter, Four Guardsmen crossing the frame and maintaining readable movement.
...
- A brutal twenty-minute combat sequence ensues between Carter and the four guards.
