...
# ID
CH019_SC005_SH004_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. High Tension $\rightarrow$ Relief $\rightarrow$ Determination. **Likely Visual Coverage Families:** - Close-ups on the "killing" blow - L.... Controlled closing frame that lands the consequence of the beat.. shifted perspective with preserved subject spacing. Characters: . Environment: described environment with stable spatial continui...
