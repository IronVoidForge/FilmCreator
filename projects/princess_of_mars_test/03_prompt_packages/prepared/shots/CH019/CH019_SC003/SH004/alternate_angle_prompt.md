...
# Positive Prompt
Use image1 as the identity reference for john carter. Use image2 as the environment reference for subterranean amphitheater arena. Maintain the project visual language: cinematic readable reference lighting, pulp planetary-romance adventure, ancient alien-world culture, frontier desert realism, weathered rock and dry wilderness terrain, non-modern clothing, weathered natural materials, tribal or gladiatorial costume logic. Alternate angle with the same beat and preserved continuity. Prisoners enter a massive subterranean amphitheater for a ten-day gladiatorial tournament. The subject from image1 is john carter, foreground inside arena floor, Massive scale difference between the lone fighter and the vast crowd/arena walls, front three-quarter left toward the scene action, Carter stands over defeated foe. Preserve the environment from image2 monumental scale, dry open Martian terrain, ancient stone and ceremonial architecture, broad processional paths and stairs, especially arena floor. close-up, eye level, portrait lens, push in, zoom subtle in, shallow subject, hard directional. Intimate composition that isolates against to capture the beat's emotional turn. Triumph and Crowd Reaction. arena floor. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo
...
- composition: Intimate composition that isolates john_carter against subterranean_amphitheater_arena to capture the beat's emotional turn.
- shot_size: close_up
...
- reference_asset_ids: john_carter; subterranean_amphitheater_arena; DESC_CH019_SC003; DESC_CH019_SC003_SH004
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH019\CH019_SC003\SH004\DIALOGUE.json
