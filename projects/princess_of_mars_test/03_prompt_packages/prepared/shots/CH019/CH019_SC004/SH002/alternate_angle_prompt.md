...
# ID
CH019_SC004_SH002_alternate_angle_prompt
...
# Positive Prompt
Use image1 as the identity reference for john carter. Use image2 as the identity reference for the secondary visible subject. Use image3 as the environment reference for subterranean amphitheater arena. Maintain the project visual language: cinematic readable reference lighting, pulp planetary-romance adventure, ancient alien-world culture, frontier desert realism, weathered rock and dry wilderness terrain, non-modern clothing, weathered natural materials, tribal or gladiatorial costume logic. Alternate angle with the same beat and preserved continuity. A massive warrior falls before a staged execution in a subterranean arena. The subject from image1 is john carter, foreground inside fighting pit, eye contact distance, profile left toward the scene action, warrior is down. The subject from image2 is john carter plays against kantos kan in the same frame. Preserve the environment from image3 monumental scale, dry open Martian terrain, ancient stone and ceremonial architecture, broad processional paths and stairs, especially fighting pit. Keep one readable subject anchor: Quick eye contact/nod between combatants. close-up, eye level, portrait lens, locked off, zoom subtle in, shallow subject, high contrast ceremonial. Over-the-shoulder composition in sharing the frame for dialogue or tension. Carter and Kan exchange looks. fighting pit. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo
...
- composition: Over-the-shoulder composition in subterranean_amphitheater_arena with john_carter, kantos_kan sharing the frame for dialogue or tension.
- shot_size: close_up
...
- reference_asset_ids: john_carter; kantos_kan; subterranean_amphitheater_arena; DESC_CH019_SC004; DESC_CH019_SC004_SH002
