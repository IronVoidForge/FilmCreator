...
# ID
CH010_SC004_SH001_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Shock/Outrage to violent action to sudden social elevation.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with crossing the frame and maintaining readable movement.. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial contin...
...
- composition: Dynamic composition in The Council Chamber/Plaza with dejah_thoris crossing the frame and maintaining readable movement.
