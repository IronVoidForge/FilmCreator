...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. From observation/curiosity to growing indignation and tension. **Likely Visual Coverage Families:** - Medium shots of the council members.... Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], unknown. Environm...
...
- composition: Dynamic composition in The interior audience chamber of Lorquas Ptomel with sarkoja, dejah_thoris crossing the frame and maintaining readable movement.
- prompt_family: shot_prompt
- reference_asset_ids: sarkoja; dejah_thoris
