...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Combat/Intensity $\rightarrow$ Chaos $\rightarrow$ Tragedy/Loss.. Tight detail framing focused on a single visual object or gesture.. balanced framing with clear spatial separation. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. Keep cont...
