...
# ID
CH014_SC005_SH004_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Anger $\rightarrow$ Horror/Shock.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with crossing the frame and maintaining readable movement.. Characters: Young female, Interacts with Tars Tarkas (receives instructions from him)., Commands a "wicked-looking" Martian watch dog., Capable of mutterin...
