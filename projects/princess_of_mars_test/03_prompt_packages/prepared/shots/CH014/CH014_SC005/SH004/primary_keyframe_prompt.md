...
# ID
CH014_SC005_SH004_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Anger $\rightarrow$ Horror/Shock.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with crossing the frame and maintaining readable movement.. Characters: Young female, Interacts with Tars Tarkas (receives instructions from him)., Commands a "wicked-looking" Martian watch dog., Capab...
