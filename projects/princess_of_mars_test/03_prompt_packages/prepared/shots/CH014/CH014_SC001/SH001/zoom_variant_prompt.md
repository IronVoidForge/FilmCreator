...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Romantic longing $\rightarrow$ Melancholy/Frustration.. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with and for spatial orientation.. Characters: . Environment: described environment with stable spatial continuity. Keep continuity exact across costume, silhouette, lighting, and spatial relat...
...
- composition: Wide composition across The outskirts of the Thark expeditionary camp with John Carter (internal monologue/reflection) and Dejah Thoris (distant) for spatial orientation.
