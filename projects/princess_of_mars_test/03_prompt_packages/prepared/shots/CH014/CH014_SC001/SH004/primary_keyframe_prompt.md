...
# ID
CH014_SC001_SH004_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Romantic longing $\rightarrow$ Melancholy/Frustration.. Controlled closing frame that lands the consequence of the beat.. Closing composition in emphasizing the shift from longing to melancholy/frustration due to Dejah Thoris's coldness.. Characters: . Environment: described environment with stable spatial continuity. Keep c...
