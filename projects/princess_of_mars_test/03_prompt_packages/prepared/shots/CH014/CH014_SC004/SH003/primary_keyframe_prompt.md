...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Competitive/Formal $\rightarrow$ Disorientation/Panic.. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: [], unknown, Big, hulking build, Powerful, brute-like stature, Seen in deep conversation with Sarkoja., is a large, imposing figure characterized by...
