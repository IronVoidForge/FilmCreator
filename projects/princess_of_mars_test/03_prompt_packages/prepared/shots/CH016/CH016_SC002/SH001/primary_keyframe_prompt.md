...
# ID
CH016_SC002_SH001_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Awe (at the city) $\rightarrow$ Ition/Dread (due to separation).. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with, placed for immediate spatial orientation.. Characters: [], unknown, Young female, Interacts with Tars Tarkas (receives instructions from him)., Commands a "wicked-...
...
- composition: Wide composition across The grand with john_carter, dejah_thoris, sola placed for immediate spatial orientation.
