...
# ID
CH016_SC001_SH004_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Exhaustion/Tension $\rightarrow$ Relief (at reaching safety) $\rightarrow$ Apprehension (approaching the city).. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of tension shifts to apprehension as the group approaches the city... Characters: [], unknown. Environm...
...
- composition: Closing composition in Martian sea bottoms that emphasizes the consequence of tension shifts to apprehension as the group approaches the city..
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH016\CH016_SC001\SH004\DIALOGUE.json
