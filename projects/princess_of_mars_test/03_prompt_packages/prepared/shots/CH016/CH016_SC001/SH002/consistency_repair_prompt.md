...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Exhaustion/Tension $\rightarrow$ Relief (at reaching safety) $\rightarrow$ Apprehension (approaching the city).. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring .. Characters: Young female, Interacts with Tars Tarkas (receives instructions from him)....
