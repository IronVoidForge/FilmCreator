...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the environment reference for the scene location. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships. A man struggles against paralysis before standing to find his clothed corpse lying nearby. The subject from image1 is protagonist, foreground inside arizona mountain cave shadows, The verticality of the new, upright naked figure contrasted against the horizontal, lifeless clothed body, facing directly toward camera, looking down. Preserve the environment from image2 especially arizona mountain cave shadows. close-up, eye level, portrait lens, locked off, zoom subtle in, shallow subject, low key night. Intimate composition that isolates against to capture the beat's emotional turn. protagonist realizes his state. shadows. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo
...
- scene_short_description: A man struggles against paralysis before standing to find his clothed corpse lying nearby.
