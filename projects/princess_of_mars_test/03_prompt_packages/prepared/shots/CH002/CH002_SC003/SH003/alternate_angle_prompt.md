...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Fear $\rightarrow$ Desperation/Exhaustion **Likely Visual Coverage Families:** - Tracking shots (Following the protagonist's flight) - Wi.... Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of land the scene consequence or transition cleanly... Characters: . Envir...
...
- composition: Closing composition in Transition the protagonist from the claustrophobic cave to the vastne... that emphasizes the consequence of land the scene consequence or transition cleanly..
