...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the environment reference for the scene location. Alternate angle with the same beat and preserved continuity. A man struggles against paralysis before rising to find his clothed corpse lying on the cave floor. The subject from image1 is described character with stable costume and silhouette, foreground entry line within deep_shadows, preserve readable body-to-environment scale in frame, front three-quarter left toward the scene action, prone position. Preserve described environment with stable spatial anchors from image2, especially deep_shadows. preserve readable body-to-environment scale in frame. medium, low angle, normal lens, handheld, shallow subject, low key night. Dynamic composition in with clear pursuit vectors and readable movement for . protagonist fighting paralysis. deep_shadows. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo.
