...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the identity reference for the secondary visible subject. Use image3 as the environment reference for the scene location. Alternate angle with the same beat and preserved continuity. Apache warriors approach a dark cave entrance under moonlight before fleeing in terror. The subject from image1 is apache warriors, midground inside rocky gorge canyon floor, warriors appear small against canyon walls, front three-quarter right toward the scene action, warriors in distance. The subject from image2 is apache warriors plays against protagonist in the same frame. Preserve the environment from image3 especially cave entrance threshold. wide, low angle, wide lens, track, deep focus, low key night. Wide composition across placed for immediate spatial orientation. warriors walking toward the cave mouth. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo
