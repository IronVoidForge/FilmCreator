...
# Positive Prompt
Use image1 as the identity reference for the primary visible subject. Use image2 as the environment reference for the scene location. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships. A man stares at a bright red star before being violently pulled into the void. The subject from image1 is described character with stable costume and silhouette, midground inside rocky_gorge_canyon, Mars relative to mountain peaks, rear three-quarter left away from camera, wide view of canyon. Preserve described environment with stable spatial anchors from image2, especially rocky_gorge_canyon. Keep celestial anchor the red planet stable in the frame. Mars relative to mountain peaks. extreme-wide, low angle, ultra-wide lens, pan, deep focus, low key night. Wide composition across with placed for immediate spatial orientation. protagonist looking at the landscape and Mars. Keep continuity exact across costume, silhouette, lighting, and spatial relationships. Avoid proper nouns in the prompt body unless text is meant to appear on screen. No text, no watermark, no logo.
