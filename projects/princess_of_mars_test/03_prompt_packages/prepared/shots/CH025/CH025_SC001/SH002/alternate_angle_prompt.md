...
# ID
CH025_SC001_SH002_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Tension/Anticipation $\rightarrow$ Aggression.. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: described character with stable costume and silhouette. Environment: described environment with stable spatial continuity. Keep continuity exact across costume, silhou...
...
- composition: Readable medium composition in Palace Gates featuring john_carter, tars_tarkas.
