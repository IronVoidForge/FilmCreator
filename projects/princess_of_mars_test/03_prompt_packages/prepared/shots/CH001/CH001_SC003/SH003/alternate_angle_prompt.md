...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Suspicion $\rightarrow$ Alertness $\rightarrow$ Chaos/Adrenaline.. Tight detail framing focused on a single visual object or gesture.. Detail composition centered on the key physical action or prop inside .. Characters: , [], No specific visual details are provided in the evidence., unknown. Environment: described environment with stab...
