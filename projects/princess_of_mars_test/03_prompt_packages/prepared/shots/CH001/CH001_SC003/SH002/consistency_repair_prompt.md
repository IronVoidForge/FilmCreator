...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Suspicion $\rightarrow$ Alertness $\rightarrow$ Chaos/Adrenaline.. Tight detail framing focused on a single visual object or gesture.. Detail composition centered on the key physical action or prop inside .. Characters: , [], No specific visual details are provided in the evidence., unknown. Environment: de...
