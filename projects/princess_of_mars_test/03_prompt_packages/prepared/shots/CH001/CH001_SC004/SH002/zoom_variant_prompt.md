...
# ID
CH001_SC004_SH002_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Adrenaline $\rightarrow$ Shock/Grief/Desperation.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: described character with stable costume and silhouette, . Environment: described environment with stable spatial continuity. K...
...
- composition: Dynamic composition in The plateau/skirmish site with john_carter, Captain James K. Powell (deceased) crossing the frame and maintaining readable movement.
