...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Horror / Grief $\rightarrow$ Desperation / Urgency.. shot size medium; camera angle eye_level; lens normal; camera motion locked_off; zoom none; focus deep_focus; lighting hard_directional; subject visibility on_screen; narration none; primary subject angle front_three_quarter_left. Active camera with tracking energy and clear spatial...
