...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Relief $\rightarrow$ Public Reverence $\rightarrow$ Intense Familial Emotion.. Wide establishing frame with a steady or lightly drifting camera.. Wide composition across with, placed for immediate spatial orientation.. Characters: described character with stable costume and silhouette. Environment: described environment with...
...
- composition: Wide composition across The Heliumite Flagship / Helium Harbor/Docking area with john_carter, dejah_thoris, mors_kajak placed for immediate spatial orientation.
