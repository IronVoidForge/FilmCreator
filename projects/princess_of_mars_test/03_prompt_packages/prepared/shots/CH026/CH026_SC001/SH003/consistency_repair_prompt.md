...
# Positive Prompt
Film shot prompt. Continuity repair pass that preserves pose, costume, lighting, and spatial relationships.. Tension $\rightarrow$ Chaos/Action $\rightarrow$ Triumph.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], unknown. Environment: described environment with stable spatial continuity. Keep c...
...
- composition: Dynamic composition in The skies above the approach to Helium with tars_tarkas, kantos_kan crossing the frame and maintaining readable movement.
