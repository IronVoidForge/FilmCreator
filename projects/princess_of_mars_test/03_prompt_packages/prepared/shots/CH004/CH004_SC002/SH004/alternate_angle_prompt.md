...
# ID
CH004_SC002_SH004_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Intimidation $\rightarrow$ Observational Curiosity. **Likely Visual Coverage Families:** * Medium shots of in regalia. * Close-ups on the.... Tight detail framing focused on a single visual object or gesture.. Detail composition centered on the key physical action or prop inside .. Characters: [], unknown, part of an assemblage of crea...
...
- reference_asset_ids: tars_tarkas; chieftain; grand_audience_chamber
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH004\CH004_SC002\SH004\DIALOGUE.json
