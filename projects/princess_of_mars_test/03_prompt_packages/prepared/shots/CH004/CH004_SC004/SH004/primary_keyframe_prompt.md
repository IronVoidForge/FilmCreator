...
# ID
CH004_SC004_SH004_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Exhaustion/Hunger $\rightarrow$ Relief/Curiosity. **Likely Visual Coverage Families:** * Medium shots of the non-verbal communication bet.... Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of **participating characters:** * the narrator * tars tarkas *...
