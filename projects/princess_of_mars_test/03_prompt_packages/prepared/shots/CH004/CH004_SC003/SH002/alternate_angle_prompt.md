...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Humiliation $\rightarrow$ Defiance $\rightarrow$ Triumph/Respect. **Likely Visual Coverage Families:** * Tight Close-ups (CU) on the punc.... Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: Green Martian (Thark) warrior and leader., readable production detail, en...
...
- composition: Readable medium composition in grand_audience_chamber featuring tars_tarkas, the_chieftain.
- prompt_family: shot_prompt
- reference_asset_ids: tars_tarkas; chieftain; grand_audience_chamber; DESC_CH004_SC003; DESC_CH004_SC003_SH002
