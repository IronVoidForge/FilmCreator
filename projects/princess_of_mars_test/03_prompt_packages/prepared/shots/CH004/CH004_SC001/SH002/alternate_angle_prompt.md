...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Awe/Trepidation $\rightarrow$ Alienation. **Likely Visual Coverage Families:** * Extreme Wide Shots (EWS) to establish the scale of the c.... Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: , Green Martian (Thark) warrior and leader., Martian (Thark) setting., pr...
...
- reference_asset_ids: tars_tarkas; DESC_CH004_SC001; DESC_CH004_SC001_SH002
