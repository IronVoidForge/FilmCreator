...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Anticipation $\rightarrow$ Sudden Alarm/Tension.. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring, .. Characters: [], unknown, Young female, Interacts with Tars Tarkas (receives instructions from him)., Commands a "wicked-looking" Martian watch dog., Capable of mutter...
