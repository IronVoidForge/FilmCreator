...
# ID
CH008_SC002_SH002_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Tension $\rightarrow$ High-Stakes Action $\rightarrow$ Victory/Chaos.. Active camera with tracking energy and clear spatial orientation.. Dynamic composition in with, crossing the frame and maintaining readable movement.. Characters: [], Insufficient evidence to establish a stable visual identity. The entity is identified as a group of wa...
...
- composition: Dynamic composition in City buildings with green_martian_warriors, Airship Crews (unseen/distant) crossing the frame and maintaining readable movement.
