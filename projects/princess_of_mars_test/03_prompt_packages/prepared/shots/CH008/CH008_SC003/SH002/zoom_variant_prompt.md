...
# ID
CH008_SC003_SH002_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Chaos $\rightarrow$ Methodical/Ruthless Efficiency.. Stable medium framing that keeps action and character readable.. Readable medium composition in featuring .. Characters: [], Insufficient evidence to establish a stable visual identity. The entity is identified as a group of warriors., unknown. Environment: described environment with st...
...
- composition: Readable medium composition in City outskirts / Ground level near the impact site featuring green_martian_warriors.
