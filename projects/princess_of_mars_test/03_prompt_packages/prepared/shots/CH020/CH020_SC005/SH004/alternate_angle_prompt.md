...
# ID
CH020_SC005_SH004_alternate_angle_prompt
...
# Positive Prompt
Film shot prompt. Alternate angle with the same beat and preserved continuity.. Gratitude $\rightarrow$ Purpose/Determination.. Controlled closing frame that lands the consequence of the beat.. Closing composition in emphasizing transition from gratitude to purpose/determination.. Characters: [], unknown. Environment: described environment with stable spatial continuity. Keep continuity exact across costume, silho...
...
- composition: Closing composition in The Ptor Farm emphasizing transition from gratitude to purpose/determination.
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH020\CH020_SC005\SH004\DIALOGUE.json
