...
# ID
CH020_SC003_SH004_primary_keyframe_prompt
...
# Positive Prompt
Film shot prompt. Primary keyframe with balanced composition and clear subject placement.. Tension $\rightarrow$ Relief/Escape.. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of and woola exit the facility into the wilderness... Characters: [], unknown. Environment: described environment with stable spatial continuity. Keep continuity exact...
...
- composition: Closing composition in Atmosphere Factory (Locks/Exits) that emphasizes the consequence of protagonist and woola exit the facility into the wilderness..
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\contracts\shots\CH020\CH020_SC003\SH004\DIALOGUE.json
