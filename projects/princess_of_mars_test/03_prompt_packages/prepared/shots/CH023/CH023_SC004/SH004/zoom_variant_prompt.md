...
# ID
CH023_SC004_SH004_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Survival Instinct $\rightarrow$ Despair/Isolation.. Controlled closing frame that lands the consequence of the beat.. Closing composition in that emphasizes the consequence of realization of being lost, shifting from survival instinct to despair/isolation.. Characters: [], unknown. Environment: described environment with stable spatial co...
