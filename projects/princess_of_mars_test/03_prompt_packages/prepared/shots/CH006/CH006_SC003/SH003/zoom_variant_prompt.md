...
# ID
CH006_SC003_SH003_zoom_variant_prompt
...
# Positive Prompt
Film shot prompt. Tighter zoom with the same beat and preserved continuity.. Adrenaline $\rightarrow$ Confusion $\rightarrow$ Social Validation/Alienation. **Likely Visual Coverage Families:** - Wide shots of the g.... Stable medium framing that keeps action and character readable.. tighter framing on the same moment. Characters: . Environment: described environment with stable spatial continuity. Keep continuity...
