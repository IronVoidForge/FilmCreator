# Title
martian_incubator_enclosure Environment Reference - Medium Spatial View

# ID
martian_incubator_enclosure_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Low walled enclosure containing an incubator area, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Light filtere...
...
- subject_id: martian_incubator_enclosure
- source_artifact_ids: ENV_aerial_battle_skies; martian_incubator_enclosure
...
- display_name: martian_incubator_enclosure
- layout_descriptor: Low walled enclosure containing an incubator area
...
- lighting_descriptor: Light filtered through a translucent/glass ceiling
...
- subject_visual_context: martian incubator enclosure: Low walled enclosure containing an incubator area. Preserve room layout, pathways, anchor structures
- fallback_fields_used: landmark_descriptor, mood_descriptor, locked_fields
...
# Repair Notes
- reference repair fallback fields used: landmark_descriptor, mood_descriptor, locked_fields
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_incubator_enclosure.json
