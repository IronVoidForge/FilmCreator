# Title
martian_incubator_enclosure Environment Reference - Detail Focus

# ID
martian_incubator_enclosure_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Low walled enclosure containing an incubator area, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Light filtered through a translucent/gl...
