# Title
martian_incubator_enclosure Environment Reference - Exterior Geography

# ID
martian_incubator_enclosure_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Low walled enclosure containing an incubator area, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Light filtered through a translu...
