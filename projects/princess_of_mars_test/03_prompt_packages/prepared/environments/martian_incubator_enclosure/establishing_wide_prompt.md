# Title
martian_incubator_enclosure Environment Reference - Establishing Wide

# ID
martian_incubator_enclosure_establishing_wide_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Low walled enclosure containing an incubator area, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Light filtered through a...
