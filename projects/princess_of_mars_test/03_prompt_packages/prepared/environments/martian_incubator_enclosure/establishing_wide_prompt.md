...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Low walled enclosure with a glass roof, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Translucent/diffused via glass ceil...
...
- layout_descriptor: Low walled enclosure with a glass roof
...
- lighting_descriptor: Translucent/diffused via glass ceiling
...
- subject_visual_context: martian incubator enclosure: Low walled enclosure with a glass roof. Preserve room layout, pathways, anchor structures
