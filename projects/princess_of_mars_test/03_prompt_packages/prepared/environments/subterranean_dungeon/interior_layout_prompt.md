...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Psychological., Unknown., None documented, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
