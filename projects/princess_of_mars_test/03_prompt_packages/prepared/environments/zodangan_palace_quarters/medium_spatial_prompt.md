# Title
zodangan_palace_quarters Environment Reference - Medium Spatial View

# ID
zodangan_palace_quarters_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, clear room or chamber layout, foreground midground background separation, pathways, anchor objects, visible scale, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, fur...
...
- source_artifact_ids: ENV_aerial_battle_skies; zodangan_palace_quarters
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodangan_palace_quarters.json
