# Title
helium_palace_sunken_gardens Environment Reference - Lighting Variant

# ID
helium_palace_sunken_gardens_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Large-scale terraced gardens with tiered palace terraces; includes royal seating areas and central botanical anchors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishin...
