...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Large-scale terraced gardens with tiered palace terraces; includes royal seating areas and central botanical anchors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns,...
