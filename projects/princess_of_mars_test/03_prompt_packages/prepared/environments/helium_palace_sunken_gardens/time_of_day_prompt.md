# Title
helium_palace_sunken_gardens Environment Reference - Time of Day Variant

# ID
helium_palace_sunken_gardens_time_of_day_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, same place rendered at a different time of day while preserving canon, Large-scale terraced gardens with tiered palace terraces; includes royal seating areas and central botanical anchors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishing...
