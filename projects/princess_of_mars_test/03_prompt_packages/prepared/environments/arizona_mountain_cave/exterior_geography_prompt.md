# Title
arizona_mountain_cave Environment Reference - Exterior Geography

# ID
arizona_mountain_cave_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Subterranean cave structure, monumental scale, stone, metal, and weathered architectural surfaces, clearly visible cave mouth in a rock face, strong entrance silhouette, rocky threshold, Intermittent glints from quartz veins a...
...
- source_artifact_ids: ENV_aerial_battle_skies; arizona_mountain_cave
...
- layout_descriptor: Subterranean cave structure
...
- lighting_descriptor: Intermittent glints from quartz veins amidst subterranean shadows
- mood_descriptor: Pungent and echoing darkness
...
- subject_visual_context: arizona mountain cave: Subterranean cave structure. Preserve cave mouth, rock face, rocky threshold, shadowed interior
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\arizona_mountain_cave.json
