# Title
arizona_mountain_cave Environment Reference - Lighting Variant

# ID
arizona_mountain_cave_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Subterranean cave structure, monumental scale, stone, metal, and weathered architectural surfaces, clearly visible cave mouth in a rock face, strong entrance silhouette, rocky threshold, Intermittent glints from quar...
