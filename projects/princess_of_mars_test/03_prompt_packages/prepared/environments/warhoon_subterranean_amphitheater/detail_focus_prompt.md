...
# Positive Prompt
Environment reference sheet, detail-focused view on a recurring anchor or landmark, described environment with stable spatial anchors, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
