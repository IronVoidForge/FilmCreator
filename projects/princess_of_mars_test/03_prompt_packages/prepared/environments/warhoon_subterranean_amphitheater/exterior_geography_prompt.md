...
# Positive Prompt
Environment reference sheet, exterior geography view with readable terrain and boundaries, described environment with stable spatial anchors, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
