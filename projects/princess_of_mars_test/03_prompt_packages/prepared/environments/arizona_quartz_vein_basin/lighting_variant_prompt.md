# Title
arizona_quartz_vein_basin Environment Reference - Lighting Variant

# ID
arizona_quartz_vein_basin_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Circular basin geometry; rugged terrain with high visibility and open spaces suitable for long-range sightlines and large leaps, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridg...
