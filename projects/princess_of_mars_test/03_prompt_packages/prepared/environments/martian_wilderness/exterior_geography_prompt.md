# Title
martian_wilderness Environment Reference - Exterior Geography

# ID
martian_wilderness_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Vast, open scale with scattered patches of flora across desolate plains, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette, clear readable c...
...
- source_artifact_ids: ENV_aerial_battle_skies; martian_wilderness
...
- display_name: martian_wilderness
- layout_descriptor: Vast, open scale with scattered patches of flora across desolate plains
...
- mood_descriptor: Harsh and desolate
...
- subject_visual_context: martian wilderness: Vast, open scale with scattered patches of flora across desolate plains. Preserve rugged terrain, rock materials, readable horizon
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_wilderness.json
