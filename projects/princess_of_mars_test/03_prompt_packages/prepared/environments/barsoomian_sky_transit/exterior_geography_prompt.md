...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No descriptive visual data is available for this environment in the provided evidence, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the spa...
...
- source_artifact_ids: ENV_aerial_battle_skies; barsoomian_sky_transit
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\barsoomian_sky_transit.json
