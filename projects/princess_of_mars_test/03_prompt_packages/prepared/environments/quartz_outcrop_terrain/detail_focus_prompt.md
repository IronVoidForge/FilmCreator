# Title
quartz_outcrop_terrain Environment Reference - Detail Focus

# ID
quartz_outcrop_terrain_detail_focus_prompt
...
# Positive Prompt
Film environment reference sheet, detail-focused view on a recurring anchor or landmark, Sharp quartz protrusions, jagged rock formations., Jagged quartz outcrops, crystalline rock fragments, uneven Martian terrain, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
