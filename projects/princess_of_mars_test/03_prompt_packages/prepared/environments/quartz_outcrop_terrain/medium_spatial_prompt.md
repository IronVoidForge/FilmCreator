# Title
quartz_outcrop_terrain Environment Reference - Medium Spatial View

# ID
quartz_outcrop_terrain_medium_spatial_prompt
...
# Positive Prompt
Film environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Sharp quartz protrusions, jagged rock formations., Jagged quartz outcrops, crystalline rock fragments, uneven Martian terrain, clear spatial layout, readable anchors and depth cues, no characters, no te...
