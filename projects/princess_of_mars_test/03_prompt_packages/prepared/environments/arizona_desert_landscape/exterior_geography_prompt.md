# Title
arizona_desert_landscape Environment Reference - Exterior Geography

# ID
arizona_desert_landscape_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No specific visual details are provided in the current evidence. The environment is identified as an Arizona desert landscape used for transitional purposes, monumental scale, stone, metal, and weathered architectural surfaces...
...
- source_artifact_ids: ENV_aerial_battle_skies; arizona_desert_landscape
...
- display_name: arizona_desert_landscape
- layout_descriptor: No specific visual details are provided in the current evidence. The environment is identified as an Arizona desert landscape used for transitional purposes
...
- subject_visual_context: arizona desert landscape
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\arizona_desert_landscape.json
