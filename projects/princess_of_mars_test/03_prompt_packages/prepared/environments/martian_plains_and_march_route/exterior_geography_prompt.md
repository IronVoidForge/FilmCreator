...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Continuous stretch of undulating terrain; long-distance vistas, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the location, clear readable cinematic lighting wi...
...
- source_artifact_ids: ENV_aerial_battle_skies; martian_plains_and_march_route
...
- layout_descriptor: Continuous stretch of undulating terrain; long-distance vistas
...
- mood_descriptor: Sweeping, alien
...
- subject_visual_context: martian plains and march route: Continuous stretch of undulating terrain; long-distance vistas. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_plains_and_march_route.json
