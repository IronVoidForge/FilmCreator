# Title
colossal_creature_lair Environment Reference - Exterior Geography

# ID
colossal_creature_lair_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Building interior with large windows overlooking a vast valley; high-altitude containment structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures de...
...
- subject_id: colossal_creature_lair
- source_artifact_ids: ENV_aerial_battle_skies; colossal_creature_lair
...
- display_name: colossal_creature_lair
- layout_descriptor: Building interior with large windows overlooking a vast valley; high-altitude containment structure
...
- lighting_descriptor: Dimly lit interior; sense of being observed from above or through large openings
- mood_descriptor: High-stakes; sense of being watched
...
- subject_visual_context: colossal creature lair: Building interior with large windows overlooking a vast valley; high-altitude containment structure. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\colossal_creature_lair.json
