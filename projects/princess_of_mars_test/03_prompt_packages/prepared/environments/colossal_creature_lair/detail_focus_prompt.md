# Title
colossal_creature_lair Environment Reference - Detail Focus

# ID
colossal_creature_lair_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Building interior with large windows overlooking a vast valley; high-altitude containment structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining...
