# Title
colossal_creature_lair Environment Reference - Medium Spatial View

# ID
colossal_creature_lair_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Building interior with large windows overlooking a vast valley; high-altitude containment structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or a...
