# Title
marble_audience_chamber Environment Reference - Interior Layout

# ID
marble_audience_chamber_interior_layout_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, clear interior layout with readable pathways, structure, and scale, No specific visual details are provided in the current evidence beyond the identifier name, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defin...
