# Title
marble_audience_chamber Environment Reference - Exterior Geography

# ID
marble_audience_chamber_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No specific visual details are provided in the current evidence beyond the identifier name, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining th...
...
- subject_id: marble_audience_chamber
- source_artifact_ids: ENV_aerial_battle_skies; marble_audience_chamber
...
- display_name: marble_audience_chamber
- layout_descriptor: No specific visual details are provided in the current evidence beyond the identifier name
...
- subject_visual_context: marble audience chamber
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\marble_audience_chamber.json
