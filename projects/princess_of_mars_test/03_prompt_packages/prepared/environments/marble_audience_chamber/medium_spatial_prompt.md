# Title
marble_audience_chamber Environment Reference - Medium Spatial View

# ID
marble_audience_chamber_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, No specific visual details are provided in the current evidence beyond the identifier name, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor str...
