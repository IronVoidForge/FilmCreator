...
# Positive Prompt
Film environment reference sheet, same place rendered at a different time of day while preserving canon, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., ancient stone tower, secluded Martian ruins, clear spatial layout, readable anchors and depth cues, no characters,...
