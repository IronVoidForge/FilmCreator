# Title
ancient_tower_ruins Environment Reference - Time of Day Variant

# ID
ancient_tower_ruins_time_of_day_prompt
...
# Positive Prompt
Film environment reference sheet, same place rendered at a different time of day while preserving canon, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., Unknown, ancient stone tower, clear spatial layout, readable anchors and depth cues, no characters, no text, no wat...
