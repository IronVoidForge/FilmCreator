...
# Positive Prompt
Film environment reference sheet, detail-focused view on a recurring anchor or landmark, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., ancient stone tower, secluded Martian ruins, clear spatial layout, readable anchors and depth cues, no characters, no text, no wate...
