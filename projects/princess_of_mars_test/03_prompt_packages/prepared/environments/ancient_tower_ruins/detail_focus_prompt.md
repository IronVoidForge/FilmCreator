# Title
ancient_tower_ruins Environment Reference - Detail Focus

# ID
ancient_tower_ruins_detail_focus_prompt
...
# Positive Prompt
Film environment reference sheet, detail-focused view on a recurring anchor or landmark, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., Unknown, ancient stone tower, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
