# Title
ancient_tower_ruins Environment Reference - Exterior Geography

# ID
ancient_tower_ruins_exterior_geography_prompt
...
# Positive Prompt
Film environment reference sheet, exterior geography view with readable terrain and boundaries, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., ancient stone tower, secluded Martian ruins, clear spatial layout, readable anchors and depth cues, no characters, no text,...
