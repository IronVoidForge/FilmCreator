...
# Positive Prompt
Film environment reference sheet, medium spatial view showing foreground, midground, and background relationships, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., ancient stone tower, secluded Martian ruins, clear spatial layout, readable anchors and depth cues, no ch...
