# Title
ancient_tower_ruins Environment Reference - Medium Spatial View

# ID
ancient_tower_ruins_medium_spatial_prompt
...
# Positive Prompt
Film environment reference sheet, medium spatial view showing foreground, midground, and background relationships, A secluded, ancient stone tower used for concealment, isolated from the main Thark settlements., Unknown, ancient stone tower, clear spatial layout, readable anchors and depth cues, no characters, no te...
