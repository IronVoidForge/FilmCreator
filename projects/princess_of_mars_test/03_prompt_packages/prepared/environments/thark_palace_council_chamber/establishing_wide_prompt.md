# Title
thark_palace_council_chamber Environment Reference - Establishing Wide

# ID
thark_palace_council_chamber_establishing_wide_prompt
...
# Positive Prompt
Film environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Formal assembly hall within the Thark stronghold, structured for council proceedings and judicial duels., martial palace hall, council chamber, clear spatial layout, readable anchors and depth cues, no characters,...
