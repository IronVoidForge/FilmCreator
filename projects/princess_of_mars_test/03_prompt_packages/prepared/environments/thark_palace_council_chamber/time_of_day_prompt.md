# Title
thark_palace_council_chamber Environment Reference - Time of Day Variant

# ID
thark_palace_council_chamber_time_of_day_prompt
...
# Positive Prompt
Film environment reference sheet, same place rendered at a different time of day while preserving canon, Formal assembly hall within the Thark stronghold, structured for council proceedings and judicial duels., martial palace hall, council chamber, clear spatial layout, readable anchors and depth cues, no characters...
