# Title
dejah_thoris_quarters Environment Reference - Lighting Variant

# ID
dejah_thoris_quarters_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza, monumental scale, stone, metal, and weathered architectural surfaces, doorways, colu...
