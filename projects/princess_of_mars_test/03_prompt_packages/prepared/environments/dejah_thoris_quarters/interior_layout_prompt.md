# Title
dejah_thoris_quarters Environment Reference - Interior Layout

# ID
dejah_thoris_quarters_interior_layout_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, clear interior layout with readable pathways, structure, and scale, Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns,...
