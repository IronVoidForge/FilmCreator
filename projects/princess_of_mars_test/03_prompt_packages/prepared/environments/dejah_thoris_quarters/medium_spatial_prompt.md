# Title
dejah_thoris_quarters Environment Reference - Medium Spatial View

# ID
dejah_thoris_quarters_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza, monumental scale, stone, metal, and weathered architectural surfaces, doorw...
