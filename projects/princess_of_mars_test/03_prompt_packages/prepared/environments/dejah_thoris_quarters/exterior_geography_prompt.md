# Title
dejah_thoris_quarters Environment Reference - Exterior Geography

# ID
dejah_thoris_quarters_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furni...
...
- subject_id: dejah_thoris_quarters
- source_artifact_ids: ENV_aerial_battle_skies; dejah_thoris_quarters
...
- layout_descriptor: Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza
...
- lighting_descriptor: Formal and imposing; dictated by the architectural layout of inner courts and upper quarters
- mood_descriptor: Grand yet confining; formal and imposing
...
- subject_visual_context: dejah thoris quarters: Multi-story vertical scale with winding stairs and high-ceilinged spaces; includes balconies/windows facing outward toward a plaza. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\dejah_thoris_quarters.json
