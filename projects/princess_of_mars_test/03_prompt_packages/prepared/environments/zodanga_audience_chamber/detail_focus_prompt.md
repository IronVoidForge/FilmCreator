...
# Positive Prompt
Film environment reference sheet, detail-focused view on a recurring anchor or landmark, Massive scale with high-ceilinged marble architecture, features a central ceremonial dais and a throne/seat of power. Includes high windows (one shattered)., Golden ceremonial chains, High windows (one shattered), clear spatial...
