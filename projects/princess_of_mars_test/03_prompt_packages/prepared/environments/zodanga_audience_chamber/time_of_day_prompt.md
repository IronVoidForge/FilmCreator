# Title
zodanga_audience_chamber Environment Reference - Time of Day Variant

# ID
zodanga_audience_chamber_time_of_day_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, same place rendered at a different time of day while preserving canon, No visual data is currently available for this environment, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, clear room or...
