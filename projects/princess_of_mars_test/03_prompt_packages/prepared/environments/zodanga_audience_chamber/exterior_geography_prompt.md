# Title
zodanga_audience_chamber Environment Reference - Exterior Geography

# ID
zodanga_audience_chamber_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No visual data is currently available for this environment, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, clear room or chamber l...
...
- source_artifact_ids: ENV_aerial_battle_skies; zodanga_audience_chamber
...
- display_name: zodanga_audience_chamber
...
- subject_visual_context: zodanga audience chamber
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodanga_audience_chamber.json
