# Title
thark_audience_chamber Environment Reference - Exterior Geography

# ID
thark_audience_chamber_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Large scale; designed for high-ranking Tharkian leadership and warriors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Formal, te...
...
- subject_id: thark_audience_chamber
- source_artifact_ids: ENV_aerial_battle_skies; thark_audience_chamber
...
- layout_descriptor: Large scale; designed for high-ranking Tharkian leadership and warriors
...
- lighting_descriptor: Formal, tense, and authoritative; high-contrast lighting used to emphasize power dynamics
- mood_descriptor: Formal, tense, and authoritative
...
- subject_visual_context: thark audience chamber: Large scale; designed for high-ranking Tharkian leadership and warriors. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\thark_audience_chamber.json
