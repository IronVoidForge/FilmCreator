# Title
duel_arena_open_plains Environment Reference - Exterior Geography

# ID
duel_arena_open_plains_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, A wide combat clearing providing sufficient space for chariot maneuvering and formal dueling, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhoue...
...
- subject_id: duel_arena_open_plains
- source_artifact_ids: ENV_aerial_battle_skies; duel_arena_open_plains
...
- display_name: duel_arena_open_plains
- layout_descriptor: A wide combat clearing providing sufficient space for chariot maneuvering and formal dueling
...
- lighting_descriptor: Harsh Martian sunlight; high-contrast desert lighting with blinding solar glare
- mood_descriptor: Intense, exposed, and harsh
...
- subject_visual_context: duel arena open plains: A wide combat clearing providing sufficient space for chariot maneuvering and formal dueling. Preserve rugged terrain, rock materials, readable horizon
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\duel_arena_open_plains.json
