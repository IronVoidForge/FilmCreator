# Title
apache_plateau_camp Environment Reference - Exterior Geography

# ID
apache_plateau_camp_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, High, expansive plateau overlooking a valley; open terrain suitable for large encampments, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette...
...
- subject_id: apache_plateau_camp
- source_artifact_ids: ENV_aerial_battle_skies; apache_plateau_camp
...
- layout_descriptor: High, expansive plateau overlooking a valley; open terrain suitable for large encampments
...
- lighting_descriptor: Wide-open sky; dusty and chaotic during skirmishes; high exposure to elements
- mood_descriptor: Exposed, chaotic, and wide-open
...
- subject_visual_context: apache plateau camp: High, expansive plateau overlooking a valley; open terrain suitable for large encampments. Preserve rugged terrain, rock materials, readable horizon
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\apache_plateau_camp.json
