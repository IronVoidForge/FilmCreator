# Title
zodanga_palace_dungeons Environment Reference - Medium Spatial View

# ID
zodanga_palace_dungeons_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Cramped cells connected by narrow corridors; underground palace vault structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures def...
