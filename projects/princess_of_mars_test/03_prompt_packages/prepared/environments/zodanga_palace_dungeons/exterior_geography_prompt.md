# Title
zodanga_palace_dungeons Environment Reference - Exterior Geography

# ID
zodanga_palace_dungeons_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Cramped cells connected by narrow corridors; underground palace vault structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Di...
...
- subject_id: zodanga_palace_dungeons
- source_artifact_ids: ENV_aerial_battle_skies; zodanga_palace_dungeons
...
- display_name: zodanga_palace_dungeons
- layout_descriptor: Cramped cells connected by narrow corridors; underground palace vault structure
...
- lighting_descriptor: Dim, low-light environment focused on shadows; dim torchlight
- mood_descriptor: Claustrophobic and oppressive
...
- subject_visual_context: zodanga palace dungeons: Cramped cells connected by narrow corridors; underground palace vault structure. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodanga_palace_dungeons.json
