# Title
zodanga_palace_dungeons Environment Reference - Lighting Variant

# ID
zodanga_palace_dungeons_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Cramped cells connected by narrow corridors; underground palace vault structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the...
