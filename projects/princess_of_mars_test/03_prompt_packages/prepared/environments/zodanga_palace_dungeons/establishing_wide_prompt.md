# Title
zodanga_palace_dungeons Environment Reference - Establishing Wide

# ID
zodanga_palace_dungeons_establishing_wide_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Cramped cells connected by narrow corridors; underground palace vault structure, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the s...
