# Title
zodanga_urban_complex Environment Reference - Exterior Geography

# ID
zodanga_urban_complex_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Dense urban layout with significant vertical scale; dominated by massive barracks and palace towers creating deep canyons, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, o...
...
- subject_id: zodanga_urban_complex
- source_artifact_ids: ENV_aerial_battle_skies; zodanga_urban_complex
...
- layout_descriptor: Dense urban layout with significant vertical scale; dominated by massive barracks and palace towers creating deep canyons
...
- lighting_descriptor: High-contrast lighting with pockets of shadow and light created by dense verticality
- mood_descriptor: Heavily guarded atmosphere
...
- subject_visual_context: zodanga urban complex: Dense urban layout with significant vertical scale; dominated by massive barracks and palace towers creating deep canyons. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodanga_urban_complex.json
