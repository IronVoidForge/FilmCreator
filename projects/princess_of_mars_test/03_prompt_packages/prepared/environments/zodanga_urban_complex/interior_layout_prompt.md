# Title
zodanga_urban_complex Environment Reference - Interior Layout

# ID
zodanga_urban_complex_interior_layout_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, clear interior layout with readable pathways, structure, and scale, Dense urban layout with significant vertical scale; dominated by massive barracks and palace towers creating deep canyons, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishi...
