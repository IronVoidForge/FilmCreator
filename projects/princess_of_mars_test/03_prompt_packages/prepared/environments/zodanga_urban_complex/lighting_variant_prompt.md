# Title
zodanga_urban_complex Environment Reference - Lighting Variant

# ID
zodanga_urban_complex_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Dense urban layout with significant vertical scale; dominated by massive barracks and palace towers creating deep canyons, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furn...
