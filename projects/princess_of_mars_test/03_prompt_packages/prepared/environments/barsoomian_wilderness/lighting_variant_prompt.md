...
# Positive Prompt
Film environment reference sheet, lighting variant preserving spatial layout while changing illumination, Expansive, desolate landscapes with unpredictable terrain shifts and wild beast territories., Predatory fauna, Strange biological anomalies, Rugged Barsoomian terrain, clear spatial layout, readable anchors and...
