# Title
atmosphere_factory Environment Reference - Detail Focus

# ID
atmosphere_factory_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Massive scale featuring a central core of machinery and towering doors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Ninth ray glow, gr...
