# Title
atmosphere_factory Environment Reference - Establishing Wide

# ID
atmosphere_factory_establishing_wide_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Massive scale featuring a central core of machinery and towering doors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Nin...
