# Title
atmosphere_factory Environment Reference - Exterior Geography

# ID
atmosphere_factory_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Massive scale featuring a central core of machinery and towering doors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Ninth ray g...
...
- subject_id: atmosphere_factory
- source_artifact_ids: ENV_aerial_battle_skies; atmosphere_factory
...
- layout_descriptor: Massive scale featuring a central core of machinery and towering doors
...
- lighting_descriptor: Ninth ray glow
...
- subject_visual_context: atmosphere factory: Massive scale featuring a central core of machinery and towering doors. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\atmosphere_factory.json
