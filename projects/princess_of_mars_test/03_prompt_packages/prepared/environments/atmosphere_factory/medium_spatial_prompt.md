# Title
atmosphere_factory Environment Reference - Medium Spatial View

# ID
atmosphere_factory_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Massive scale featuring a central core of machinery and towering doors, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the...
