# Title
zodangan_aviation_training_grounds Environment Reference - Exterior Geography

# ID
zodangan_aviation_training_grounds_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Defined by high-altitude flight corridors, aerial maneuvering zones, and eighth-ray propulsion mechanics, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the loca...
...
- subject_id: zodangan_aviation_training_grounds
- source_artifact_ids: ENV_aerial_battle_skies; zodangan_aviation_training_grounds
...
- layout_descriptor: Defined by high-altitude flight corridors, aerial maneuvering zones, and eighth-ray propulsion mechanics
...
- lighting_descriptor: High altitude; technical focus on mechanical propulsion
- mood_descriptor: Windy, technical, and high-altitude
...
- subject_visual_context: zodangan aviation training grounds: Defined by high-altitude flight corridors, aerial maneuvering zones, and eighth-ray propulsion mechanics. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodangan_aviation_training_grounds.json
