# Title
zodangan_aviation_training_grounds Environment Reference - Detail Focus

# ID
zodangan_aviation_training_grounds_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Defined by high-altitude flight corridors, aerial maneuvering zones, and eighth-ray propulsion mechanics, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the location, H...
