# Title
zodanga_palace_throne_room Environment Reference - Exterior Geography

# ID
zodanga_palace_throne_room_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges, monumental scale, stone, metal, and weathered architectural surfaces, door...
...
- subject_id: zodanga_palace_throne_room
- source_artifact_ids: ENV_aerial_battle_skies; zodanga_palace_throne_room
...
- layout_descriptor: Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges
...
- lighting_descriptor: Influenced by large window openings; transitions from ceremonial stillness to shifting shadows caused by combat
- mood_descriptor: High-stakes and chaotic, transitioning from ceremonial stillness to violent skirmish
...
- subject_visual_context: zodanga palace throne room: Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\zodanga_palace_throne_room.json
