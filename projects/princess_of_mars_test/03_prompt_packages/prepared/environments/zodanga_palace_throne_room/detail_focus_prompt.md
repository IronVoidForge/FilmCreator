# Title
zodanga_palace_throne_room Environment Reference - Detail Focus

# ID
zodanga_palace_throne_room_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges, monumental scale, stone, metal, and weathered architectural surfaces, doorways, c...
