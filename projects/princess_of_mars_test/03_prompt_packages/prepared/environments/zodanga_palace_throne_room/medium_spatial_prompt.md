# Title
zodanga_palace_throne_room Environment Reference - Medium Spatial View

# ID
zodanga_palace_throne_room_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges, monumental scale, stone, metal, and weathered architect...
