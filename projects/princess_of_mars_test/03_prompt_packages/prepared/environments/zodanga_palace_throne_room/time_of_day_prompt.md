# Title
zodanga_palace_throne_room Environment Reference - Time of Day Variant

# ID
zodanga_palace_throne_room_time_of_day_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, same place rendered at a different time of day while preserving canon, Massive scale with high ceilings; includes a central throne platform/raised dais and wide floor space capable of hosting skirmishes or cavalry charges, monumental scale, stone, metal, and weathered architectural surfa...
