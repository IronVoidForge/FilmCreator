...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, High desert gorge with jagged cliffs and silhouetted mountain ridges, monumental scale, stone, metal, and weathered architectural surfaces, clearly visible cave mouth in a rock face, strong entrance silhouet...
...
- source_artifact_ids: ENV_aerial_battle_skies; rocky_gorge_nightscape
...
- layout_descriptor: High desert gorge with jagged cliffs and silhouetted mountain ridges
...
- lighting_descriptor: Starlit night sky with a crimson Martian glow
- mood_descriptor: Nocturnal/Transitionary
...
- subject_visual_context: rocky gorge nightscape: High desert gorge with jagged cliffs and silhouetted mountain ridges. Preserve cave mouth, rock face, rocky threshold, shadowed interior
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\rocky_gorge_nightscape.json
