...
# Positive Prompt
Film environment reference sheet, lighting variant preserving spatial layout while changing illumination, Large window frames, view of the Hudson River, scholarly furniture., Unknown, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
