...
# Positive Prompt
Film environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Large window frames, view of the Hudson River, scholarly furniture., Unknown, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
