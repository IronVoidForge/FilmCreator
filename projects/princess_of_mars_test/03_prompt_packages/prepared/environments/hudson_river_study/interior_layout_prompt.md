...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Large window frames, view of the Hudson River, scholarly furniture., Unknown, clear spatial layout, readable anchors and depth cues, no characters, no text, no watermark.
