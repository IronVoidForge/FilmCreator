# Title
captive_chamber_murals Environment Reference - Exterior Geography

# ID
captive_chamber_murals_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the spac...
...
- subject_id: captive_chamber_murals
- source_artifact_ids: ENV_aerial_battle_skies; captive_chamber_murals
...
- layout_descriptor: Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold
...
- lighting_descriptor: Influenced by depicted night cycles on the murals; warmth provided by furs and food
- mood_descriptor: Shifts from intimacy (Sola's care) to tension (presence of a guarding beast)
...
- subject_visual_context: captive chamber murals: Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\captive_chamber_murals.json
