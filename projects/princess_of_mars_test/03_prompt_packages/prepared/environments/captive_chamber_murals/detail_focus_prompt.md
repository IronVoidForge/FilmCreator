# Title
captive_chamber_murals Environment Reference - Detail Focus

# ID
captive_chamber_murals_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, Infl...
