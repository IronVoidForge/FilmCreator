# Title
captive_chamber_murals Environment Reference - Medium Spatial View

# ID
captive_chamber_murals_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structure...
