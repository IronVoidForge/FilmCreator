# Title
captive_chamber_murals Environment Reference - Establishing Wide

# ID
captive_chamber_murals_establishing_wide_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Interior cell containing a sleeping area; a Watch Dog is positioned at the threshold, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining...
