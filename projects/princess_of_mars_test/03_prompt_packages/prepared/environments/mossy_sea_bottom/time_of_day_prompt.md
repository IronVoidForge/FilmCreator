...
# Positive Prompt
Film environment reference sheet, same place rendered at a different time of day while preserving canon, A featureless, endless expanse with a flat topography, no distinct landmarks or topographical variations are noted., Thick mossy surface, Absorbing texture (swallows tracks/footprints), clear spatial layout, read...
