...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Contains specialized incubation chambers for biological preservation, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, clear readabl...
...
- source_artifact_ids: ENV_aerial_battle_skies; warhoon_incubator_site
...
- layout_descriptor: Contains specialized incubation chambers for biological preservation
...
- subject_visual_context: warhoon incubator site: Contains specialized incubation chambers for biological preservation. Preserve room layout, pathways, anchor structures
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\warhoon_incubator_site.json
