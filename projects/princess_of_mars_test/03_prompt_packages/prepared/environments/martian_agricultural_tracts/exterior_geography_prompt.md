...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Expansive horizons with a network of underground irrigation systems and rhythmic agricultural patterns, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the locati...
...
- source_artifact_ids: ENV_aerial_battle_skies; martian_agricultural_tracts
...
- layout_descriptor: Expansive horizons with a network of underground irrigation systems and rhythmic agricultural patterns
...
- lighting_descriptor: Open sky under a bright Martian sun
- mood_descriptor: Organized, engineered, and highly refined
...
- subject_visual_context: martian agricultural tracts: Expansive horizons with a network of underground irrigation systems and rhythmic agricultural patterns. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_agricultural_tracts.json
