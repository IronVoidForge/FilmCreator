# Title
martian_sleeping_chamber Environment Reference - Exterior Geography

# ID
martian_sleeping_chamber_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No visual details are currently provided in the source material, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, clear room or cham...
...
- subject_id: martian_sleeping_chamber
- source_artifact_ids: ENV_aerial_battle_skies; martian_sleeping_chamber
...
- layout_descriptor: No visual details are currently provided in the source material
...
- subject_visual_context: martian sleeping chamber
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_sleeping_chamber.json
