# Title
martian_sleeping_chamber Environment Reference - Medium Spatial View

# ID
martian_sleeping_chamber_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, No visual details are currently provided in the source material, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space,...
