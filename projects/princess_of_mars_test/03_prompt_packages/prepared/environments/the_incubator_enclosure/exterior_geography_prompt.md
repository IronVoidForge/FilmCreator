...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Walled perimeter enclosing a central egg-hatching zone and a communal gathering area, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the location, Sun-drenched;...
...
- source_artifact_ids: ENV_aerial_battle_skies; the_incubator_enclosure
...
- layout_descriptor: Walled perimeter enclosing a central egg-hatching zone and a communal gathering area
...
- lighting_descriptor: Sun-drenched; high solar exposure
- mood_descriptor: Ritualistic
...
- subject_visual_context: the incubator enclosure: Walled perimeter enclosing a central egg-hatching zone and a communal gathering area. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\the_incubator_enclosure.json
