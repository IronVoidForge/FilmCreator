...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Vast desert plains with an infinite horizon, anchored spatially by two distinct moons overhead., Dual-moon illumination, Silver lunar glow, clear spatial layout, readable anchors and depth cues, no characters, no te...
