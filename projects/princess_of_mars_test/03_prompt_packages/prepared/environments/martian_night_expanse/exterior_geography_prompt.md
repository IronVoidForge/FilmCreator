...
# Positive Prompt
Film environment reference sheet, exterior geography view with readable terrain and boundaries, Vast desert plains with an infinite horizon, anchored spatially by two distinct moons overhead., Dual-moon illumination, Silver lunar glow, clear spatial layout, readable anchors and depth cues, no characters, no text, no...
