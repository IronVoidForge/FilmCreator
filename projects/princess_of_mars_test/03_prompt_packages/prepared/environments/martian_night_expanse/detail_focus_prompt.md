...
# Positive Prompt
Film environment reference sheet, detail-focused view on a recurring anchor or landmark, Vast desert plains with an infinite horizon, anchored spatially by two distinct moons overhead., Dual-moon illumination, Silver lunar glow, clear spatial layout, readable anchors and depth cues, no characters, no text, no waterm...
