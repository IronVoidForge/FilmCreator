...
# Positive Prompt
Film environment reference sheet, wide establishing reference with clear horizon, depth, and geography, Vast desert plains with an infinite horizon, anchored spatially by two distinct moons overhead., Dual-moon illumination, Silver lunar glow, clear spatial layout, readable anchors and depth cues, no characters, no...
