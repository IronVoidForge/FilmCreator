# Title
ancient_cliffside_cave Environment Reference - Exterior Geography

# ID
ancient_cliffside_cave_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Narrow trail leads to a large cave; located between steep cliffs and a deep ravine, monumental scale, stone, metal, and weathered architectural surfaces, clearly visible cave mouth in a rock face, strong entrance silhouette, r...
...
- source_artifact_ids: ENV_aerial_battle_skies; ancient_cliffside_cave
...
- layout_descriptor: Narrow trail leads to a large cave; located between steep cliffs and a deep ravine
...
- lighting_descriptor: Dim, subterranean lighting with shadows cast by high cliff walls
- mood_descriptor: Cool, heavy atmosphere with a sense of enclosure and mysterious drowsiness
...
- subject_visual_context: ancient cliffside cave: Narrow trail leads to a large cave; located between steep cliffs and a deep ravine. Preserve cave mouth, rock face, rocky threshold, shadowed interior
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\ancient_cliffside_cave.json
