...
# Positive Prompt
Film environment reference sheet, lighting variant preserving spatial layout while changing illumination, Massive internal scale contrasted by a narrow, claustrophobic entrance, situated on a high, precarious cliffside., monumental scale, dry open Martian terrain, clear spatial layout, readable anchors and depth cue...
