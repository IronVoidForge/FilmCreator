...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, A large, ancient subterranean chamber accessed via a narrow entrance on a high, precarious cliffside trail., Transition from bright exterior sunlight to dee...
