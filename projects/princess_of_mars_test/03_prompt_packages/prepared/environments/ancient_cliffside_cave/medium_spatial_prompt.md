...
# Positive Prompt
Film environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Massive internal scale contrasted by a narrow, claustrophobic entrance, situated on a high, precarious cliffside., monumental scale, dry open Martian terrain, clear spatial layout, readable anchors and...
