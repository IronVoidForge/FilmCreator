...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Massive internal scale contrasted by a narrow, claustrophobic entrance, situated on a high, precarious cliffside., Ancient stone walls and floors, Narrow cliffside entrance, clear spatial layout, readable anchors an...
