...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, same place rendered at a different time of day while preserving canon, A large, ancient subterranean chamber accessed via a narrow entrance on a high, precarious cliffside trail., Transition from bright exterior sunlight to deep...
