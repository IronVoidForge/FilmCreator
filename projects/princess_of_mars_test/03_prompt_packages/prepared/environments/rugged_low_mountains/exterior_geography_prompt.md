# Title
rugged_low_mountains Environment Reference - Exterior Geography

# ID
rugged_low_mountains_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No specific visual details are provided in the source material for this environment, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette, rugg...
...
- source_artifact_ids: ENV_aerial_battle_skies; rugged_low_mountains
...
- layout_descriptor: No specific visual details are provided in the source material for this environment
...
- subject_visual_context: rugged low mountains
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\rugged_low_mountains.json
