...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Wide, expansive flats surrounding the capital; level enough for transit and mass movement, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the location, clear rea...
...
- source_artifact_ids: ENV_aerial_battle_skies; helium_plains
...
- layout_descriptor: Wide, expansive flats surrounding the capital; level enough for transit and mass movement
...
- mood_descriptor: vast, open, combat-ready
...
- subject_visual_context: helium plains: Wide, expansive flats surrounding the capital; level enough for transit and mass movement. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\helium_plains.json
