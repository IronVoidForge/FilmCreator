...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Circular layout featuring a central glass incubator, scale is defined by the contrast between low walls and 15ft Martian warriors., monumental scale, dry open Martian terrain, clear spatial layout, readable anchors...
