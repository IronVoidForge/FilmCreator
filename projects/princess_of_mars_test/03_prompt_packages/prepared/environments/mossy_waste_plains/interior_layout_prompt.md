...
# Positive Prompt
Film environment reference sheet, clear interior layout with readable pathways, structure, and scale, Endless horizon, featureless terrain, absence of water sources., Harsh, exposed, desolate, sense of extreme exhaustion and heat., Vast mossy waste, trackless Martian plains, clear spatial layout, readable anchors an...
