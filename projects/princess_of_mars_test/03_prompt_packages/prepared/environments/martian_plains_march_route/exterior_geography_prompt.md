...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Vast, open plains suitable for epic military marches, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette, Sunlight hitting red dust, Epic/Mil...
...
- source_artifact_ids: ENV_aerial_battle_skies; martian_plains_march_route
...
- layout_descriptor: Vast, open plains suitable for epic military marches
...
- lighting_descriptor: Sunlight hitting red dust
- mood_descriptor: Epic/Military scale
...
- subject_visual_context: martian plains march route: Vast, open plains suitable for epic military marches. Preserve rugged terrain, rock materials, readable horizon
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_plains_march_route.json
