# Title
arizona_quartz_vein_location Environment Reference - Exterior Geography

# ID
arizona_quartz_vein_location_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Vast mountain ranges containing localized mineral deposits and rocky terrain, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette, Harsh, high...
...
- subject_id: arizona_quartz_vein_location
- source_artifact_ids: ENV_aerial_battle_skies; arizona_quartz_vein_location
...
- layout_descriptor: Vast mountain ranges containing localized mineral deposits and rocky terrain
...
- lighting_descriptor: Harsh, high-desert sunlight
- mood_descriptor: Isolation and frontier wilderness; dry and dusty atmosphere
...
- subject_visual_context: arizona quartz vein location: Vast mountain ranges containing localized mineral deposits and rocky terrain. Preserve rugged terrain, rock materials, readable horizon
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\arizona_quartz_vein_location.json
