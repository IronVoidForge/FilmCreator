# Title
arizona_quartz_vein_location Environment Reference - Lighting Variant

# ID
arizona_quartz_vein_location_lighting_variant_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, lighting variant preserving spatial layout while changing illumination, Vast mountain ranges containing localized mineral deposits and rocky terrain, monumental scale, stone, metal, and weathered architectural surfaces, recognizable ridge lines, rock formations, and terrain silhouette, H...
