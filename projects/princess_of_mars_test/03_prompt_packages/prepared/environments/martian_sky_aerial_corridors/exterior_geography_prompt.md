...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, Vast, open expanses defined by aerial transit paths, monumental scale, stone, metal, and weathered architectural surfaces, clear landmark or anchor feature defining the location, Varying light based on altitude and time of day...
...
- source_artifact_ids: ENV_aerial_battle_skies; martian_sky_aerial_corridors
...
- layout_descriptor: Vast, open expanses defined by aerial transit paths
...
- lighting_descriptor: Varying light based on altitude and time of day; includes sunlit sky corridors and flashes from projectile fire
- mood_descriptor: High-speed, kinetic, and expansive
...
- subject_visual_context: martian sky aerial corridors: Vast, open expanses defined by aerial transit paths. Preserve core landmark, scale, and material identity
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\martian_sky_aerial_corridors.json
