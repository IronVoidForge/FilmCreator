# Title
royal_palace_quarters Environment Reference - Detail Focus

# ID
royal_palace_quarters_detail_focus_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, detail-focused view on a recurring anchor or landmark, Grand palace halls and elite living quarters; high-status residential area within the central Zodanga complex near the Jeddak's seat, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishing...
