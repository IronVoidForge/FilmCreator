# Title
royal_palace_quarters Environment Reference - Medium Spatial View

# ID
royal_palace_quarters_medium_spatial_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, medium spatial view showing foreground, midground, and background relationships, Grand palace halls and elite living quarters; high-status residential area within the central Zodanga complex near the Jeddak's seat, monumental scale, stone, metal, and weathered architectural surfaces, doo...
