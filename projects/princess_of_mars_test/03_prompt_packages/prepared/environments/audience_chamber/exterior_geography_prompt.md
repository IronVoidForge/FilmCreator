# Title
audience_chamber Environment Reference - Exterior Geography

# ID
audience_chamber_exterior_geography_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked spatial reference. Environment reference sheet, exterior geography view with readable terrain and boundaries, No descriptive data is currently available for this environment, monumental scale, stone, metal, and weathered architectural surfaces, doorways, columns, furnishings, or anchor structures defining the space, clear room or cham...
...
- subject_id: audience_chamber
- source_artifact_ids: ENV_aerial_battle_skies; audience_chamber
...
- display_name: audience_chamber
- layout_descriptor: No descriptive data is currently available for this environment
...
- subject_visual_context: audience chamber
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\environments\audience_chamber.json
