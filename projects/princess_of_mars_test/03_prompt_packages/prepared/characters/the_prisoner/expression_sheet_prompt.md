# Title
the_prisoner Character Reference - Expression Sheet

# ID
the_prisoner_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, the prisoner, lean athletic build, angular face; dark eyes; practical short hair, worn cloth, leather, and practical field materials, upright and ready, focused and self-controlled, cinematic reada...
...
- source_artifact_ids: CHAR_apache_warriors; the_prisoner
...
- identity_descriptor: the prisoner
...
- subject_visual_context: the prisoner: the prisoner. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\the_prisoner.json
