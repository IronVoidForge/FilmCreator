...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, unknown, a preserved, desiccated female corpse, mummified state, clean neutral studio background, clear silhouette, consistent costume layers, con...
