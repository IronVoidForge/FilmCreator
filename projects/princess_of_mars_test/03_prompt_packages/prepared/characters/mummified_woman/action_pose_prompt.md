...
# Positive Prompt
Film character reference sheet, dynamic action pose that preserves anatomy, costume, and identity, mummified appearance, [], No specific visual details are provided in the available evidence. The character is identified only by her state as a mummified woman., unknown, clean neutral studio background, clear silhouet...
