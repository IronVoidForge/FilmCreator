# Title
tal_hajus Character Reference - Front View

# ID
tal_hajus_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Green skin, Grand, authoritative Thark regalia., Green Martian (Thark) warrior and ruler., unknown, clean neutral studio background, clear silh...
...
- identity_descriptor: Green skin, Grand, authoritative Thark regalia., Green Martian (Thark) warrior and ruler., unknown
- body_descriptor: Bestial, monstrous, and brutal frame.
- face_descriptor: 
- costume_descriptor: Grand, authoritative Thark regalia.
- posture_descriptor: 
