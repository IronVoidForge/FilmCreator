# Title
martian_leader Character Reference - 3/4 View

# ID
martian_leader_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, A massive, four-armed Martian warrior leader., readable production detail, 15ft tall, heavy humanoid frame with four arms., clean neutral studio b...
...
- identity_descriptor: A massive, four-armed Martian warrior leader., readable production detail, 15ft tall, heavy humanoid frame with four arms.
- body_descriptor: 15ft tall; heavy humanoid frame with four arms.
- face_descriptor: 
- costume_descriptor: Unarmed, carrying a metal armlet as a peace offering.
- posture_descriptor: 
