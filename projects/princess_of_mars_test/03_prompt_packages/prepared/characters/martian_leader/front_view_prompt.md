...
# Positive Prompt
Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, A massive, four-armed Martian warrior leader., readable production detail, 15ft tall, heavy humanoid frame with four arms., clean neutral studio background, clear silhouette, consistent costume layers, co...
