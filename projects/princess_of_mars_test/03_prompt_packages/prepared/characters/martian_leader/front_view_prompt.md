...
# Positive Prompt
Film character reference sheet, front-facing full-body reference with the camera square to the subject, A massive, four-armed Martian warrior., 15ft tall, heavy humanoid frame with four arms., Martian warrior race., Dismounts from an eight-legged mount, clean neutral studio background, clear silhouette, consistent c...
