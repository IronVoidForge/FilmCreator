...
# Positive Prompt
Action character reference portrait, dynamic action pose that preserves anatomy, costume, and identity, A massive, four-armed Martian warrior leader., readable production detail, 15ft tall, heavy humanoid frame with four arms., clean neutral studio background, clear silhouette, consistent costume layers, consistent...
