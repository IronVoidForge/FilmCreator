# Title
little_boy Character Reference - 3/4 View

# ID
little_boy_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, A young boy, lean athletic build, worn cloth, leather, and practical field materials; associated with Dejah Thoris; associated with John Carter, upright and ready, focused and self-controlled, lean athletic...
