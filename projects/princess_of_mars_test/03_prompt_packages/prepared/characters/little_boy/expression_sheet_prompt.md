# Title
little_boy Character Reference - Expression Sheet

# ID
little_boy_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, A young boy, lean athletic build, worn cloth, leather, and practical field materials; associated with Dejah Thoris; associated with John Carter, upright and ready, focused and self-controlled, lean...
...
- subject_id: little_boy
- source_artifact_ids: CHAR_apache_warriors; little_boy
...
- display_name: little_boy
- identity_descriptor: A young boy
- body_descriptor: lean athletic build
- face_descriptor: 
- costume_descriptor: worn cloth, leather, and practical field materials; associated with Dejah Thoris; associated with John Carter
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: lean athletic build A young boy
...
- subject_visual_context: little boy: A young boy. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\little_boy.json
