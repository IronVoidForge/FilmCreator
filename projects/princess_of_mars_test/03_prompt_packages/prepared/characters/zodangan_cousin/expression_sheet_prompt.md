# Title
zodangan_cousin Character Reference - Expression Sheet

# ID
zodangan_cousin_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, humanoid nonhuman biped, human scale, angular face; dark eyes; practical short hair, worn cloth, leather, and practical field materials; Associated with Than Kosis; Associated with John Carter, upr...
...
- subject_id: zodangan_cousin
- source_artifact_ids: CHAR_apache_warriors; zodangan_cousin
...
- display_name: zodangan_cousin
- identity_descriptor: humanoid nonhuman biped
- body_descriptor: human scale
- face_descriptor: angular face; dark eyes; practical short hair
- costume_descriptor: worn cloth, leather, and practical field materials; Associated with Than Kosis; Associated with John Carter
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: human scale humanoid nonhuman biped
...
- subject_visual_context: zodangan cousin: humanoid nonhuman biped. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\zodangan_cousin.json
