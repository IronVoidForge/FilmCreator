# Title
dak_kova Character Reference - 3/4 View

# ID
dak_kova_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Ferocious expression, Ornate or distinct Warhoon warrior attire, likely heavy or ritualistic combat gear., Ferocious Warhoon warrior and martial l...
...
- identity_descriptor: Ferocious expression, Ornate or distinct Warhoon warrior attire, likely heavy or ritualistic combat gear., Ferocious Warhoon warrior and martial leader., unknown
- body_descriptor: unknown
- face_descriptor: 
- costume_descriptor: Ornate or distinct Warhoon warrior attire, likely heavy or ritualistic combat gear.
- posture_descriptor: 
