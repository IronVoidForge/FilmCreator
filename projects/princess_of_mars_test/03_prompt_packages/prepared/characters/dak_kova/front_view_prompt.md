# Title
dak_kova Character Reference - Front View

# ID
dak_kova_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Ferocious expression, Ornate or distinct Warhoon warrior attire, likely heavy or ritualistic combat gear., Ferocious Warhoon warrior and martia...
