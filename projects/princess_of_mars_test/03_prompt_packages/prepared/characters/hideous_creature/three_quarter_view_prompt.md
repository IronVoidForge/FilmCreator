# Title
hideous_creature Character Reference - 3/4 View

# ID
hideous_creature_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, hideous creature, lean athletic build, angular face; dark eyes; practical short hair; described as "hideous"; hideous appearance, worn cloth, leather, and practical field materials; associated with Little B...
