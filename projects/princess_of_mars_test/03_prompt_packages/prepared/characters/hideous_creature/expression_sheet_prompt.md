# Title
hideous_creature Character Reference - Expression Sheet

# ID
hideous_creature_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, hideous creature, lean athletic build, angular face; dark eyes; practical short hair; described as "hideous"; hideous appearance, worn cloth, leather, and practical field materials; associated with...
...
- subject_id: hideous_creature
- source_artifact_ids: CHAR_apache_warriors; hideous_creature
...
- identity_descriptor: hideous creature
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair; described as "hideous"; hideous appearance
- costume_descriptor: worn cloth, leather, and practical field materials; associated with Little Boy; associated with John Carter
...
- subject_visual_context: hideous creature: hideous creature. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\hideous_creature.json
