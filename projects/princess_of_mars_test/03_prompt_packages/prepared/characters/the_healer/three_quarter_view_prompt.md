...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Female, Warhoon anatomy (inferred), Healer's or elder's garments, Ancient female Warhoon, clean neutral studio background, clear silhouette, consi...
...
- identity_descriptor: Female, Warhoon anatomy (inferred), Healer's or elder's garments, Ancient female Warhoon
- body_descriptor: unknown
- face_descriptor: 
- costume_descriptor: Healer's or elder's garments
- posture_descriptor: 
