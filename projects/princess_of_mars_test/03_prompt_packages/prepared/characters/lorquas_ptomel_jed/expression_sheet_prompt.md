# Title
lorquas_ptomel_jed Character Reference - Expression Sheet

# ID
lorquas_ptomel_jed_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, lorquas ptomel jed, lean athletic build, angular face; dark eyes; practical short hair, worn cloth, leather, and practical field materials, upright and ready, focused and self-controlled, cinematic...
...
- subject_id: lorquas_ptomel_jed
- source_artifact_ids: CHAR_apache_warriors; lorquas_ptomel_jed
...
- display_name: lorquas_ptomel_jed
- identity_descriptor: lorquas ptomel jed
...
- subject_visual_context: lorquas ptomel jed: lorquas ptomel jed. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\lorquas_ptomel_jed.json
