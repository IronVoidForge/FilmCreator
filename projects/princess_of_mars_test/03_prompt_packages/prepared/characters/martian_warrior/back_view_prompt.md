...
# Positive Prompt
Back-view character reference portrait, rear view with costume back detail and full silhouette clarity, readable production detail, lean athletic build, Martian setting, decisive, efficient movement, clean neutral studio background, clear silhouette, consistent costume layers, consistent facial structure, no narrati...
