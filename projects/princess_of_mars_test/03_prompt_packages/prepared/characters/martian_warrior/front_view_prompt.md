...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, readable production detail, lean athletic build, Martian setting, decisive, efficient movement, clean neutral studio background, clear silhouet...
