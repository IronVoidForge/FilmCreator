...
# Positive Prompt
Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, readable production detail, lean athletic build, Martian setting, decisive, efficient movement, clean neutral studio background, clear silhouette, consistent costume layers, consistent facial structure, n...
