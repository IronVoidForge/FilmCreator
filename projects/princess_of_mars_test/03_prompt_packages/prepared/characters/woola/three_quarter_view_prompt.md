# Title
woola Character Reference - 3/4 View

# ID
woola_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Multi-tusked, Large scale, Large, beastly silhouette with prominent tusks., A large, multi-tusked Martian hound (calot)., clean neutral studio bac...
