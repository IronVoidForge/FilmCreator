# Title
woola Character Reference - Expression Sheet

# ID
woola_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, Multi-tusked, Large scale, Large, beastly silhouette with prominent tusks., A large, multi-tusked Martian hound (calot)., clean neutral s...
...
- display_name: woola
- identity_descriptor: Multi-tusked, Large scale, Large, beastly silhouette with prominent tusks., A large, multi-tusked Martian hound (calot).
- body_descriptor: Large, beastly canine frame.
- face_descriptor: 
- costume_descriptor: Large, beastly silhouette with prominent tusks.
- posture_descriptor: 
