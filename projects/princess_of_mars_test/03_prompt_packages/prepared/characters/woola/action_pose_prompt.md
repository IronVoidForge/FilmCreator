# Title
woola Character Reference - Action Pose

# ID
woola_action_pose_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Action character reference portrait, dynamic action pose that preserves anatomy, costume, and identity, Multi-tusked, Large scale, Large, beastly silhouette with prominent tusks., A large, multi-tusked Martian hound (calot)., clean neutral studio backgroun...
