...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Beautiful appearance, Prisoner attire (specifics unknown)., A beautiful Red Martian woman., unknown, clean neutral studio background, clear silhou...
...
- identity_descriptor: Beautiful appearance, Prisoner attire (specifics unknown)., A beautiful Red Martian woman., unknown
- body_descriptor: unknown
- face_descriptor: 
- costume_descriptor: Prisoner attire (specifics unknown).
- posture_descriptor: 
