# Title
red_martian_prisoner Character Reference - Expression Sheet

# ID
red_martian_prisoner_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, red martian prisoner, lean athletic build, angular face; dark eyes; practical short hair, worn cloth, leather, and practical field materials, upright and ready, focused and self-controlled, cinemat...
...
- subject_id: red_martian_prisoner
- source_artifact_ids: CHAR_apache_warriors; red_martian_prisoner
...
- identity_descriptor: red martian prisoner
...
- subject_visual_context: red martian prisoner: red martian prisoner. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\red_martian_prisoner.json
