# Title
james_k_powell Character Reference - 3/4 View

# ID
james_k_powell_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, james k powell, lean athletic build, angular face; dark eyes; practical short hair, worn cloth, leather, and practical field materials; associated with john carter, upright and ready, focused and self-contr...
...
- subject_id: james_k_powell
- source_artifact_ids: CHAR_apache_warriors; james_k_powell
...
- display_name: james_k_powell
- identity_descriptor: james k powell
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair
- costume_descriptor: worn cloth, leather, and practical field materials; associated with john carter
...
- subject_visual_context: james k powell: james k powell. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\james_k_powell.json
