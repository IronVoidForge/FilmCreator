...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Back-view character reference portrait, rear view with costume back detail and full silhouette clarity, A lifeless human body, human scale biped, clothed; worn cloth, leather, and practical field materials; associated with the Protagonist, upright and ready, focused and self-controlled, clothed human scale biped A...
