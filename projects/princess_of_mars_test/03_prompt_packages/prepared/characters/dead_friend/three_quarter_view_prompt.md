# Title
dead_friend Character Reference - 3/4 View

# ID
dead_friend_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, deceased individual, lean athletic build, worn cloth, leather, and practical field materials; referenced as a "friend", upright and ready, focused and self-controlled, lean athletic build deceased individua...
...
- identity_descriptor: deceased individual
- body_descriptor: lean athletic build
- face_descriptor: 
- costume_descriptor: worn cloth, leather, and practical field materials; referenced as a "friend"
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: lean athletic build deceased individual
...
- subject_visual_context: dead friend: deceased individual. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
