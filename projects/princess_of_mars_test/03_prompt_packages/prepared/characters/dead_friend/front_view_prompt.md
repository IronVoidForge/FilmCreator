# Title
dead_friend Character Reference - Front View

# ID
dead_friend_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, deceased individual, lean athletic build, worn cloth, leather, and practical field materials; referenced as a "friend", upright and ready, focused and self-controlled, lean athletic build deceased indivi...
