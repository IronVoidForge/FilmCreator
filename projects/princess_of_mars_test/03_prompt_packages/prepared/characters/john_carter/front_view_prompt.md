# Title
john_carter Character Reference - Front View

# ID
john_carter_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Human male, Transitioning from 1860s cavalry attire to Martian spoils (silks and furs)., Human male, Earthling, former Confederate cavalry offi...
