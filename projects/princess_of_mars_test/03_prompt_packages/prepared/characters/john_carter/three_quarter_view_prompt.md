# Title
john_carter Character Reference - 3/4 View

# ID
john_carter_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Human male, Transitioning from 1860s cavalry attire to Martian spoils (silks and furs)., Human male, Earthling, former Confederate cavalry officer...
