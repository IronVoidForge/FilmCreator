# Title
bull_ape Character Reference - Front View

# ID
bull_ape_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Large, quadrupedal monster creature, Large-scale quadrupedal frame, angular face; dark eyes; practical short hair; Quadrupedal morphology; Large scale, worn cloth, leather, and practical field materials;...
