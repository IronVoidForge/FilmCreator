...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Humanoid ape anatomy, Extreme height (10-15ft), Four-armed anatomy, Massive, four-armed primate silhouette., clean neutral studio background, c...
