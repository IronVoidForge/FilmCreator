# Title
bull_ape Character Reference - 3/4 View

# ID
bull_ape_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Large, quadrupedal monster creature, Large-scale quadrupedal frame, angular face; dark eyes; practical short hair; Quadrupedal morphology; Large scale, worn cloth, leather, and practical field materials; As...
