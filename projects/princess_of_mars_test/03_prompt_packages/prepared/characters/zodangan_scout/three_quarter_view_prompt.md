# Title
Zodangan Scout Character Reference - 3/4 View
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, unknown, Martian aviator and royal relative., Martian setting, associated with Zodangan royalty and aviation., clean neutral studio background, cl...
...
- identity_descriptor: unknown, Martian aviator and royal relative., Martian setting, associated with Zodangan royalty and aviation.
