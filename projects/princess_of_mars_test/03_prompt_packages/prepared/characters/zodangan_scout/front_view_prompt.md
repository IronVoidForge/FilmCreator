# Title
Zodangan Scout Character Reference - Front View
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, unknown, Martian aviator and royal relative., Martian setting, associated with Zodangan royalty and aviation., clean neutral studio background,...
