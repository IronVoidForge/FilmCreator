...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Fierce appearance, Non-humanoid silhouette defined by multiple limbs., A fierce, multi-legged non-humanoid creature., unknown, clean neutral st...
