...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Fierce appearance, Non-humanoid silhouette defined by multiple limbs., A fierce, multi-legged non-humanoid creature., unknown, clean neutral studi...
