...
# Positive Prompt
Film character reference sheet, profile view with a clean silhouette and side-plane facial structure, Female Green Martian (Thark), readable production detail, enormous frame built for combat and intimidation, Martian setting, clean neutral studio background, clear silhouette, consistent costume layers, consistent f...
