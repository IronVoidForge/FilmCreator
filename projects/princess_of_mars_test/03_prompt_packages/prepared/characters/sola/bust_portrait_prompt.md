...
# Positive Prompt
Film character reference sheet, bust portrait with head, shoulders, and facial structure readable, Female Green Martian (Thark), readable production detail, enormous frame built for combat and intimidation, Martian setting, clean neutral studio background, clear silhouette, consistent costume layers, consistent faci...
