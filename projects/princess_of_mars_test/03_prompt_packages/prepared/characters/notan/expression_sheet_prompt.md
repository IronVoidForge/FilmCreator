# Title
notan Character Reference - Expression Sheet

# ID
notan_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, A humanoid official of the Zodangan court, human scale bipedal humanoid, angular face; dark eyes; practical short hair; humanoid morphology, worn cloth, leather, and practical field materials; asso...
...
- subject_id: notan
- source_artifact_ids: CHAR_apache_warriors; notan
...
- display_name: notan
- identity_descriptor: A humanoid official of the Zodangan court
...
- costume_descriptor: worn cloth, leather, and practical field materials; associated with Than Kosis
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: human scale bipedal humanoid A humanoid official of the Zodangan court
...
- subject_visual_context: notan: A humanoid official of the Zodangan court. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\notan.json
