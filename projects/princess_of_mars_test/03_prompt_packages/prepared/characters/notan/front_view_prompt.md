...
# Positive Prompt
Film character reference sheet, front-facing full-body reference with the camera square to the subject, No specific physical description is provided in the available evidence., unknown, clean neutral studio background, clear silhouette, consistent costume layers, consistent facial structure, no narrative action, no...
