...
# Positive Prompt
Film character reference sheet, three-quarter view with readable face, torso, and costume layers, No specific physical description is provided in the available evidence., unknown, clean neutral studio background, clear silhouette, consistent costume layers, consistent facial structure, no narrative action, no text,...
