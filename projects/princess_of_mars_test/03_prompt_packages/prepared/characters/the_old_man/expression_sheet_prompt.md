# Title
the_old_man Character Reference - Expression Sheet

# ID
the_old_man_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, An elderly, solitary guardian, lean athletic build, angular face; dark eyes; practical short hair; Diadem with a unique "ninth ray" stone; Secretive expression, A diadem containing a glowing ninth-...
...
- subject_id: the_old_man
- source_artifact_ids: CHAR_apache_warriors; the_old_man
...
- identity_descriptor: An elderly, solitary guardian
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair; Diadem with a unique "ninth ray" stone; Secretive expression
- costume_descriptor: A diadem containing a glowing ninth-ray stone.; worn cloth, leather, and practical field materials; Associated with John Carter
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: A diadem containing a glowing ninth-ray stone. lean athletic build An elderly, solitary guardian
...
- subject_visual_context: the old man: An elderly, solitary guardian. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\the_old_man.json
