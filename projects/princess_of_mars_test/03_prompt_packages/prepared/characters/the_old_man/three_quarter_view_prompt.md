# Title
the_old_man Character Reference - 3/4 View

# ID
the_old_man_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, An elderly, solitary guardian, lean athletic build, angular face; dark eyes; practical short hair; Diadem with a unique "ninth ray" stone; Secretive expression, A diadem containing a glowing ninth-ray stone...
