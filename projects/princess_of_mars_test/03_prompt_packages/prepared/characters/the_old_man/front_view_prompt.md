# Title
the_old_man Character Reference - Front View

# ID
the_old_man_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, An elderly, solitary guardian, lean athletic build, angular face; dark eyes; practical short hair; Diadem with a unique "ninth ray" stone; Secretive expression, A diadem containing a glowing ninth-ray st...
