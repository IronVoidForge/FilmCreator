...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Back-view character reference portrait, rear view with costume back detail and full silhouette clarity, Humanoid ruler of Zodanga, human scale bipedal humanoid, angular face; dark eyes; practical short hair; humanoid morphology, worn cloth, leather, and practical field materials; Associated with Sab Than; Associate...
