# Title
red_prisoner Character Reference - Expression Sheet

# ID
red_prisoner_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, humanoid non-human biped, human scale, bipedal frame, angular face; dark eyes; practical short hair; bipedal morphology, worn cloth, leather, and practical field materials; associated with Sola; as...
...
- subject_id: red_prisoner
- source_artifact_ids: CHAR_apache_warriors; red_prisoner
...
- display_name: red_prisoner
- identity_descriptor: humanoid non-human biped
- body_descriptor: human scale, bipedal frame
- face_descriptor: angular face; dark eyes; practical short hair; bipedal morphology
- costume_descriptor: worn cloth, leather, and practical field materials; associated with Sola; associated with Sarkoja
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: human scale, bipedal frame humanoid non-human biped
...
- subject_visual_context: red prisoner: humanoid non-human biped. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\red_prisoner.json
