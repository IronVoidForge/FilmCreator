# Title
protagonist Character Reference - 3/4 View

# ID
protagonist_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, An experienced Earthman fighter who undergoes a physical metamorphosis, Highly fit, athletic human male with superhuman agility, weathered angular face; dark steady eyes; short practical frontier cut; Post-...
