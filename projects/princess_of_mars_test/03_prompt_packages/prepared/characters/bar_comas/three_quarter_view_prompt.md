# Title
bar_comas Character Reference - 3/4 View

# ID
bar_comas_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, A dignified Warhoon leader, lean athletic build, angular face; dark eyes; practical short hair, Ornate or formal attire reflecting the status of a Jeddak.; worn cloth, leather, and practical field materials...
