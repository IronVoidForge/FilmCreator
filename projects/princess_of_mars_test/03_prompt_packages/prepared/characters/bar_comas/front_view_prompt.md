# Title
bar_comas Character Reference - Front View

# ID
bar_comas_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, A dignified Warhoon leader, lean athletic build, angular face; dark eyes; practical short hair, Ornate or formal attire reflecting the status of a Jeddak.; worn cloth, leather, and practical field materi...
