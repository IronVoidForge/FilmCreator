# Title
bar_comas Character Reference - Expression Sheet

# ID
bar_comas_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, A dignified Warhoon leader, lean athletic build, angular face; dark eyes; practical short hair, Ornate or formal attire reflecting the status of a Jeddak.; worn cloth, leather, and practical field...
...
- subject_id: bar_comas
- source_artifact_ids: CHAR_apache_warriors; bar_comas
...
- identity_descriptor: A dignified Warhoon leader
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair
- costume_descriptor: Ornate or formal attire reflecting the status of a Jeddak.; worn cloth, leather, and practical field materials; Associated with Dak Kova; Associated with Warhoon Warriors
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: Ornate or formal attire reflecting the status of a Jeddak. lean athletic build A dignified Warhoon leader
...
- subject_visual_context: bar comas: A dignified Warhoon leader. Use coherent group visual language using non-modern tribal, frontier, or alien-world materials as appropriate; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\bar_comas.json
