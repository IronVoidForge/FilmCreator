# Title
martian_mounts Character Reference - 3/4 View

# ID
martian_mounts_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Massive, eight-legged alien beasts used as mounts, Large-scale, octopedal (eight-legged) frame, animal skull structure with species-specific proportions; animal eyes with a predatory alertness; natural anim...
