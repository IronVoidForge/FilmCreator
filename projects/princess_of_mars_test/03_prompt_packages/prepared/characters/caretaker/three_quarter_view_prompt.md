# Title
caretaker Character Reference - 3/4 View

# ID
caretaker_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Highly skilled in mental control/telepathy (non-visual trait), Clothing suggesting long-term seclusion and isolation., An elderly, "dried-up" Mart...
