# Title
caretaker Character Reference - Front View

# ID
caretaker_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Highly skilled in mental control/telepathy (non-visual trait), Clothing suggesting long-term seclusion and isolation., An elderly, "dried-up" M...
