# Title
sab_than Character Reference - Front View

# ID
sab_than_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Humanoid prince of Zodanga, lean athletic build, angular face; dark eyes; practical short hair; humanoid morphology, worn cloth, leather, and practical field materials; Associated with Than Kosis; Associ...
