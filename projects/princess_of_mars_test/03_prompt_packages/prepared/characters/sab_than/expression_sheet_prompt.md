# Title
sab_than Character Reference - Expression Sheet

# ID
sab_than_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, Humanoid prince of Zodanga, lean athletic build, angular face; dark eyes; practical short hair; humanoid morphology, worn cloth, leather, and practical field materials; Associated with Than Kosis;...
...
- subject_id: sab_than
- source_artifact_ids: CHAR_apache_warriors; sab_than
...
- identity_descriptor: Humanoid prince of Zodanga
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair; humanoid morphology
- costume_descriptor: worn cloth, leather, and practical field materials; Associated with Than Kosis; Associated with Dejah Thoris; Associated with Kantos Kan
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: lean athletic build Humanoid prince of Zodanga
...
- subject_visual_context: sab than: Humanoid prince of Zodanga. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\sab_than.json
