# Title
black_haired_woman Character Reference - Expression Sheet

# ID
black_haired_woman_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, female with black hair, lean athletic build, angular face; dark eyes; practical short hair; black hair, worn cloth, leather, and practical field materials, upright and ready, focused and self-contr...
...
- subject_id: black_haired_woman
- source_artifact_ids: CHAR_apache_warriors; black_haired_woman
...
- display_name: black_haired_woman
- identity_descriptor: female with black hair
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair; black hair
...
- locked_fields: lean athletic build female with black hair
...
- subject_visual_context: black haired woman: female with black hair. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\black_haired_woman.json
