...
# Positive Prompt
Film character reference sheet, front-facing full-body reference with the camera square to the subject, A green Martian leader of a hardy, martial species., readable production detail, large-framed, described as being "out of proportion" to human-scale furniture (desks)., clean neutral studio background, clear silho...
