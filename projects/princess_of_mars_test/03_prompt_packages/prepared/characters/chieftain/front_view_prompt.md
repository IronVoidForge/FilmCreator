# Title
the_chieftain Character Reference - Front View
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, green skin, heavily armed martial attire., A green Martian leader of a hardy, martial species., unknown, clean neutral studio background, clear...
