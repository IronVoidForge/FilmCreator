...
# Positive Prompt
Film character reference sheet, profile view with a clean silhouette and side-plane facial structure, A green Martian leader of a hardy, martial species., readable production detail, large-framed, described as being "out of proportion" to human-scale furniture (desks)., clean neutral studio background, clear silhoue...
