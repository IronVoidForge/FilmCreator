...
# Positive Prompt
Film character reference sheet, bust portrait with head, shoulders, and facial structure readable, A green Martian leader of a hardy, martial species., readable production detail, large-framed, described as being "out of proportion" to human-scale furniture (desks)., clean neutral studio background, clear silhouette...
