...
# Positive Prompt
Film character reference sheet, dynamic action pose that preserves anatomy, costume, and identity, A green Martian leader of a hardy, martial species., readable production detail, large-framed, described as being "out of proportion" to human-scale furniture (desks)., clean neutral studio background, clear silhouette...
