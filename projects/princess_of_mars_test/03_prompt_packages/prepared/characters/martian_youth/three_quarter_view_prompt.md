# Title
martian_youth Character Reference - 3/4 View

# ID
martian_youth_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Small-scale humanoid non-human biped, Small scale; bipedal morphology, angular face; dark eyes; practical short hair; bipedal morphology, worn cloth, leather, and practical field materials, upright and read...
