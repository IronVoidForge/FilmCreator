# Title
martian_youth Character Reference - Expression Sheet

# ID
martian_youth_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, Small-scale humanoid non-human biped, Small scale; bipedal morphology, angular face; dark eyes; practical short hair; bipedal morphology, worn cloth, leather, and practical field materials, upright...
...
- subject_id: martian_youth
- source_artifact_ids: CHAR_apache_warriors; martian_youth
...
- display_name: martian_youth
- identity_descriptor: Small-scale humanoid non-human biped
- body_descriptor: Small scale; bipedal morphology
...
- locked_fields: Small scale; bipedal morphology. Small-scale humanoid non-human biped
...
- subject_visual_context: martian youth: Small-scale humanoid non-human biped. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\martian_youth.json
