# Title
martian_youth Character Reference - Front View

# ID
martian_youth_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Small-scale humanoid non-human biped, Small scale; bipedal morphology, angular face; dark eyes; practical short hair; bipedal morphology, worn cloth, leather, and practical field materials, upright and r...
