...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Male, 4'0" height, unknown, A male Martian of small stature., clean neutral studio background, clear silhouette, consistent costume layers, con...
