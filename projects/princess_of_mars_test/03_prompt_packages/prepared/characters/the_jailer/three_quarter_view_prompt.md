...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, Warhoon biology (inferred), standard Warhoon soldier or guard attire., A member of the Warhoon horde., unknown, clean neutral studio background, c...
