...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, Warhoon biology (inferred), standard Warhoon soldier or guard attire., A member of the Warhoon horde., unknown, clean neutral studio background...
