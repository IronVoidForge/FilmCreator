# Title
female_healer Character Reference - Expression Sheet

# ID
female_healer_expression_sheet_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Character expression reference sheet, expression sheet showing several clear emotional beats without changing costume, An ancient, ugly Warhoon woman, lean athletic build, angular face; dark eyes; practical short hair; Unattractive/ugly facial features; Warhoon morphology (humanoid biped), Practical or tribal heale...
...
- subject_id: female_healer
- source_artifact_ids: CHAR_apache_warriors; female_healer
...
- identity_descriptor: An ancient, ugly Warhoon woman
- body_descriptor: lean athletic build
- face_descriptor: angular face; dark eyes; practical short hair; Unattractive/ugly facial features; Warhoon morphology (humanoid biped)
- costume_descriptor: Practical or tribal healer attire (inferred); worn cloth, leather, and practical field materials; Associated with Protagonist
- posture_descriptor: upright and ready
- expression_descriptor: focused and self-controlled
- locked_fields: Practical or tribal healer attire (inferred) lean athletic build An ancient, ugly Warhoon woman
...
- subject_visual_context: female healer: An ancient, ugly Warhoon woman. Use feral or primitive non-modern appearance, rough natural materials if clothed, no tailored business attire; do not modernize clothing or portrait styling
...
- C:\FilmCreator_MC\projects\princess_of_mars_test\02_story_analysis\descriptors\characters\female_healer.json
