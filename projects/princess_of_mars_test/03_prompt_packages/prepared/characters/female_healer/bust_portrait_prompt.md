# Title
female_healer Character Reference - Bust Portrait

# ID
female_healer_bust_portrait_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Bust character reference portrait, bust portrait with head, shoulders, and facial structure readable, An ancient, ugly Warhoon woman, lean athletic build, angular face; dark eyes; practical short hair; Unattractive/ugly facial features; Warhoon morphology (humanoid biped), Practical or tribal healer attire (inferre...
