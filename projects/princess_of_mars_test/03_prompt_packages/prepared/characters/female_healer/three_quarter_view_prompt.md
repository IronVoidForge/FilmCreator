# Title
female_healer Character Reference - 3/4 View

# ID
female_healer_three_quarter_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, An ancient, ugly Warhoon woman, lean athletic build, angular face; dark eyes; practical short hair; Unattractive/ugly facial features; Warhoon morphology (humanoid biped), Practical or tribal healer attire...
