# Title
female_healer Character Reference - Front View

# ID
female_healer_front_view_prompt
...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, An ancient, ugly Warhoon woman, lean athletic build, angular face; dark eyes; practical short hair; Unattractive/ugly facial features; Warhoon morphology (humanoid biped), Practical or tribal healer atti...
