...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Three-quarter character reference portrait, three-quarter view with readable face, torso, and costume layers, the keeper, human scale, bipedal morphology, worn cloth, leather, and practical field materials; associated with Atmosphere Plant workers, upright and ready, focused and self-controlled, cinematic readable...
