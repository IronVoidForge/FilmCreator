...
# Positive Prompt
If this prompt is later used with an image reference, treat image1 as the locked identity reference. Front-view character reference portrait, front-facing full-body reference with the camera square to the subject, the keeper, human scale, bipedal morphology, worn cloth, leather, and practical field materials; associated with Atmosphere Plant workers, upright and ready, focused and self-controlled, cinematic readab...
