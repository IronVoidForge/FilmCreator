...
### Phase 12 â€“ Character Sheet Generation and Approval

#### Goal

Generate approved character references from prompt-preparation bundles using a staged workflow that preserves identity before expanding view coverage.

#### Staged Generation Plan

1. Text-to-image portrait or bust
   - establish the canonical face and identity anchor first
2. Image-to-image full-body
   - use the approved portrait as the identity source for the body reference
3. Image-to-image supporting views
   - derive profile, 3/4, back, action, and expression variants from the approved full-body or portrait ref

#### Output Targets

- approved portrait or bust reference
- approved full-body neutral reference
- approved supporting view variants
- approval queue and lock state

#### Prompt Source

- consumes prompt-preparation bundles from Phase 11.5
- uses character descriptors from Phase 11.7

### Phase 13 â€“ Environment Reference Generation and Approval

#### Goal

Generate approved environment references from prompt-preparation bundles using a staged workflow that preserves spatial identity before expanding sub-location and lighting variants.

#### Staged Generation Plan

1. Text-to-image establishing view
   - establish layout, scale, and landmark identity first
2. Image-to-image spatial reference
   - use the approved establishing view as the source for a stabilized spatial ref
3. Image-to-image supporting variants
   - derive detail, lighting, mood, and time-of-day variants from the approved spatial ref

#### Output Targets

- approved establishing environment reference
- approved stabilized spatial reference
- approved supporting environment variants
- approval queue and lock state

#### Prompt Source

- consumes prompt-preparation bundles from Phase 11.5
- uses environment descriptors from Phase 11.7
...
- this phase should consume approved character and environment references generated by Phases 12 and 13
